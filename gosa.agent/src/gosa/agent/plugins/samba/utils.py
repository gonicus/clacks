    ...
    def process(self, obj, key, valDict):
        ...
        if len(valDict[key]['value']):
            ...
            valDict[u'CtxMinEncryptionLevel'] = GOsaObjectFactory.createNewProperty(valDict[key]['backend'],
                    '00', value=[res['CtxMinEncryptionLevel']])
