...
var envinfo = {"qx.application":"rpc_test.Application","qx.debug":false,"qx.optimization.basecalls":true,"qx.optimization.comments":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.variants":true,"qx.revision":"exportiert","qx.theme":"rpc_test.theme.Theme","qx.version":"1.5"};
for (var k in envinfo) qx.$$environment[k] = envinfo[k];

if (!qx.$$libraries) qx.$$libraries = {};
var libinfo = {"__out__":{"sourceUri":"script"},"qx":{"resourceUri":"resource","sourceUri":"script","version":"1.5"},"rpc_test":{"resourceUri":"resource","sourceUri":"script","version":"trunk"}};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:rpc_test.00d8f5c8d450.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="rpc_test.Application",b="engine.version",a="os.name";
...
(function(){var t="WebSocket",s="rpc_test.Application",r="Last name",q="Test Wss",p="First name",o="Username",n="givenName",m='login',l="GOsa JSON-RPC service",k="wss://amqp.intranet.gonicus.de:9000",d="Hello from JavaScript!",j="... nothing yet",h="https://amqp.intranet.gonicus.de/rpc",c="rpc_test/test.png",b='tester',g="uid",f="sn",i="execute",a='cajus';
...
if(t in window){webSocket=new WebSocket(z);
}else{webSocket=new MozWebSocket(z);
}this.debug(webSocket);
var y=new qx.io.remote.Rpc(h,l);
y.setTimeout(10000);
res=y.callSync(m,a,b);
var u=new qx.ui.form.Button(q,c);
v.add(u,{left:200,top:50});
u.addListener(i,function(e){webSocket.send(d);
});
var w=new qx.ui.basic.Label(j);
v.add(w,{left:400,top:50});
webSocket.onmessage=function(e){w.setValue(e.data);
};
var x=new rpc_test.MyModel();
x.setColumns([p,r,o],[n,f,g]);
x.setBlockSize(20);
var B={tableColumnModel:function(D){return new qx.ui.table.columnmodel.Resize(D);
}};
var A=new qx.ui.table.Table(x,B);
var C=A.getTableColumnModel().getBehavior();
v.add(A,{left:10,top:100,right:10});
}}});
})();
...
}}},members:{__kH:null,__kG:null,createRequest:function(){return new qx.io.remote.Request(this.getUrl(),F,a);
...
if(self.__kG!=bN){self.__kH=self.__kG;
self.__kG=bN;
...
}},fixUrl:function(bV){if(this.__kH==null||this.__kG==null||this.__kH==d||this.__kH==this.__kG){return bV;
}var bW=bV.indexOf(this.__kH);

if(bW==-1){return bV;
}return (bV.substring(0,bW)+this.__kG+bV.substring(bW+this.__kH.length));
...
this.__kM=++qx.io.remote.Request.__kM;
},events:{"created":j,"configured":j,"sending":j,"receiving":j,"completed":P,"aborted":j,"failed":P,"timeout":P},statics:{__kM:0,methodAllowsRequestBody:function(T){return (T==O)||(T==I);
...
},init:true,apply:B},crossDomain:{check:k,init:false},fileUpload:{check:k,init:false},transport:{check:l,nullable:true},useBasicHttpAuth:{check:k,init:false},parseJson:{check:k,init:true}},members:{__kI:null,__kJ:null,__kK:null,__kL:null,__kM:null,send:function(){qx.io.remote.RequestQueue.getInstance().add(this);
...
},__kN:qx.event.GlobalError.observeMethod(function(e){var U=e.clone();
U.setTarget(this);
...
},setRequestHeader:function(bf,bg){this.__kI[bf]=bg;
},removeRequestHeader:function(bh){delete this.__kI[bh];
},getRequestHeader:function(bi){return this.__kI[bi]||null;
},getRequestHeaders:function(){return this.__kI;
},setParameter:function(bj,bk,bl){if(bl){this.__kK[bj]=bk;
}else{this.__kJ[bj]=bk;
}},removeParameter:function(bm,bn){if(bn){delete this.__kK[bm];
}else{delete this.__kJ[bm];
}},getParameter:function(bo,bp){if(bp){return this.__kK[bo]||null;
}else{return this.__kJ[bo]||null;
}},getParameters:function(bq){return (bq?this.__kK:this.__kJ);
},setFormField:function(br,bs){this.__kL[br]=bs;
},removeFormField:function(bt){delete this.__kL[bt];
},getFormField:function(bu){return this.__kL[bu]||null;
},getFormFields:function(){return this.__kL;
},getSequenceNumber:function(){return this.__kM;
}},destruct:function(){this.setTransport(null);
this.__kI=this.__kJ=this.__kK=this.__kL=null;
}});
})();
(function(){var t="Integer",s="aborted",r="_onaborted",q="_on",p="_applyEnabled",o="Boolean",n="sending",m="__kO",l="interval",k="failed",c="qx.io.remote.RequestQueue",j="timeout",g="completed",b="__je",a="queued",f="io.maxrequests",d="receiving",h="singleton";
...
this.__je.addListener(l,this._oninterval,this);
},properties:{enabled:{init:true,check:o,apply:p},maxTotalRequests:{check:t,nullable:true},maxConcurrentRequests:{check:t,init:qx.core.Environment.get(f)},defaultTimeout:{check:t,init:5000}},members:{__dF:null,__kO:null,__kP:null,__je:null,getRequestQueue:function(){return this.__dF;
},getActiveQueue:function(){return this.__kO;
},_debug:function(){var u;
},_check:function(){this._debug();
if(this.__kO.length==0&&this.__dF.length==0){this.__je.stop();
}if(!this.getEnabled()){return;
}if(this.__dF.length==0||(this.__dF[0].isAsynchronous()&&this.__kO.length>=this.getMaxConcurrentRequests())){return;
}if(this.getMaxTotalRequests()!=null&&this.__kP>=this.getMaxTotalRequests()){return;
...
}},_remove:function(x){qx.lang.Array.remove(this.__kO,x);
x.dispose();
this._check();
},__kQ:0,_onsending:function(e){e.getTarget().getRequest()._onsending(e);
...
z[r](event);
}}catch(B){}}},_oninterval:function(e){var I=this.__kO;
...
},__kR:function(){var bR=this.getRequest();
...
}this.__kS=qx.bom.Iframe.create({id:I,name:I,src:K});
qx.bom.element.Style.set(this.__kS,z,A);
this.__kT=qx.bom.Element.create(o,{id:J,name:J,target:I});
qx.bom.element.Style.set(this.__kT,z,A);
qx.dom.Element.insertEnd(this.__kT,qx.dom.Node.getBodyElement(document));
this.__cN=qx.bom.Element.create(c,{id:b,name:b});
qx.dom.Element.insertEnd(this.__cN,this.__kT);
qx.dom.Element.insertEnd(this.__kS,qx.dom.Node.getBodyElement(document));
qx.event.Registration.addListener(this.__kS,a,this._onload,this);
this.__kU=qx.lang.Function.listener(this._onreadystatechange,this);
qx.bom.Event.addNativeListener(this.__kS,E,this.__kU);
...
},_numericMap:{"uninitialized":1,"loading":2,"loaded":2,"interactive":3,"complete":4}},members:{__cN:null,__kV:0,__kT:null,__kS:null,__kU:null,send:function(){var M=this.getMethod();
var O=this.getUrl();
...
return;
}while(this.__kV<T){this.setState(qx.io.remote.Exchange._nativeMap[++this.__kV]);
...
},destruct:function(){if(this.__kS){qx.event.Registration.removeListener(this.__kS,a,this._onload,this);
qx.bom.Event.removeNativeListener(this.__kS,E,this.__kU);
if((qx.core.Environment.get(j)==y)){this.__kS.src=qx.util.ResourceManager.getInstance().toUri(w);
}qx.dom.Element.remove(this.__kS);
}
if(this.__kT){qx.dom.Element.remove(this.__kT);
}this.__kS=this.__kT=this.__cN=null;
}});
})();
...
},__kW:function(F){var G=function(){qx.bom.Event.removeNativeListener(F,h,G);
...
var s=++qx.io.remote.transport.Script.__kX;

if(s>=2000000000){qx.io.remote.transport.Script.__kX=s=1;
}this.__eS=null;
this.__kX=s;
},statics:{__kX:0,_instanceRegistry:{},ScriptTransport_PREFIX:f,ScriptTransport_ID_PARAM:b,ScriptTransport_DATA_PARAM:h,handles:{synchronous:false,asynchronous:true,crossDomain:true,fileUpload:false,programaticFormFields:false,responseTypes:[m,l,o]},isSupported:function(){return true;
...
}})},members:{__kV:0,__eS:null,__kX:null,send:function(){var x=this.getUrl();
x+=(x.indexOf(p)>=0?r:p)+qx.io.remote.transport.Script.ScriptTransport_ID_PARAM+q+this.__kX;
...
}qx.io.remote.transport.Script._instanceRegistry[this.__kX]=this;
...
return;
}while(this.__kV<B){this.setState(qx.io.remote.Exchange._nativeMap[++this.__kV]);
...
},destruct:function(){if(this.__eS){delete qx.io.remote.transport.Script._instanceRegistry[this.__kX];
...
}},properties:{parseJson:{check:C,init:true}},members:{__kY:false,__kV:0,__la:null,getRequest:function(){if(this.__la===null){this.__la=qx.io.remote.transport.XmlHttp.createRequestObject();
this.__la.onreadystatechange=qx.lang.Function.bind(this._onreadystatechange,this);
}return this.__la;
},send:function(){this.__kV=0;
...
if(bk==4){if(!qx.io.remote.Exchange.wasSuccessful(this.getStatusCode(),bk,this.__kY)){if(this.getState()===b){this.setState(g);
}this.failed();
return;
}}if(bk==3&&this.__kV==1){this.setState(qx.io.remote.Exchange._nativeMap[++this.__kV]);
}while(this.__kV<bk){this.setState(qx.io.remote.Exchange._nativeMap[++this.__kV]);
...
if(qx.io.remote.Exchange.wasSuccessful(bF,bG,this.__kY)){try{bH=this.getRequest().responseXML;
...
qx.Mixin.define(j,{events:{"execute":g},properties:{command:{check:b,apply:f,event:a,nullable:true}},members:{__kC:null,__kD:false,__kE:null,_bindableProperties:[d,k,l,m,h,c],execute:function(){var o=this.getCommand();

if(o){if(this.__kD){this.__kD=false;
}else{this.__kD=true;
o.execute(this);
}}this.fireEvent(n);
},__kF:function(e){if(this.__kD){this.__kD=false;
return;
}this.__kD=true;
this.execute();
},_applyCommand:function(p,q){if(q!=null){q.removeListenerById(this.__kE);
}
if(p!=null){this.__kE=p.addListener(n,this.__kF,this);
}var t=this.__kC;

if(t==null){this.__kC=t={};
}var u;
...
this.__lk=[];
this.__ll={};
},members:{__lj:null,__lk:null,__ll:null,__lm:null,init:function(f){},getRowCount:function(){throw new Error("getRowCount is abstract");
...
},getColumnCount:function(){return this.__lj.length;
},getColumnIndexById:function(y){return this.__ll[y];
},getColumnId:function(z){return this.__lj[z];
},getColumnName:function(A){return this.__lk[A];
},setColumnIds:function(B){this.__lj=B;
this.__ll={};

for(var i=0;i<B.length;i++){this.__ll[B[i]]=i;
}this.__lk=new Array(B.length);
if(!this.__lm){this.fireEvent(e);
}},setColumnNamesByIndex:function(C){if(this.__lj.length!=C.length){throw new Error("this.__columnIdArr and columnNameArr have different length: "+this.__lj.length+" != "+C.length);
}this.__lk=C;
this.fireEvent(e);
},setColumnNamesById:function(D){this.__lk=new Array(this.__lj.length);

for(var i=0;i<this.__lj.length;++i){this.__lk[i]=D[this.__lj[i]];
}},setColumns:function(E,F){var G=this.__lj.length==0||F;

if(F==null){if(this.__lj.length==0){F=E;
}else{F=this.__lj;
}}
...
this.__lx=null;
this.__ly=null;
},properties:{blockSize:{check:c,init:50},maxCachedBlockCount:{check:c,init:15},clearCacheOnRemove:{check:b,init:false},blockConcurrentLoadRowCount:{check:b,init:true}},members:{__lp:null,__lu:null,__lq:null,__lr:null,__ls:null,__lt:null,__lv:null,__lw:null,__ln:null,__lo:null,__ly:null,__lx:null,__lz:false,_getIgnoreCurrentRequest:function(){return this.__lu;
},getRowCount:function(){if(this.__lp==-1){if(!this.__lz||!this.getBlockConcurrentLoadRowCount()){this.__lz=true;
this._loadRowCount();
}return (this.__lp==-1)?0:this.__lp;
}else{return this.__lp;
}},_loadRowCount:function(){throw new Error("_loadRowCount is abstract");
},_onRowCountLoaded:function(f){if(this.getBlockConcurrentLoadRowCount()){this.__lz=false;
}if(f==null||f<0){f=0;
}this.__lp=Number(f);
...
if(this.__lr!=-1){var h=this._cancelCurrentRequest();
...
this.__lz=true;
this._loadRowCount();
},clearCache:function(){this.__lv={};
this.__lw=0;
},getCacheContent:function(){return {sortColumnIndex:this.__ln,sortAscending:this.__lo,rowCount:this.__lp,lruCounter:this.__lq,rowBlockCache:this.__lv,rowBlockCount:this.__lw};
},restoreCacheContent:function(j){if(this.__lr!=-1){var k=this._cancelCurrentRequest();

if(k){this.__lr=-1;
this.__lu=false;
}else{this.__lu=true;
}}this.__ln=j.sortColumnIndex;
this.__lo=j.sortAscending;
this.__lp=j.rowCount;
this.__lq=j.lruCounter;
this.__lv=j.rowBlockCache;
this.__lw=j.rowBlockCount;
var l={firstRow:0,lastRow:this.__lp-1,firstColumn:0,lastColumn:this.getColumnCount()-1};
...
for(var w=0;w<=o;w++){var q=this.__lv[w];
...
if(r!=null){u[t]=r;
}}}}},prefetchRows:function(x,y){if(this.__lr==-1){var z=this.getBlockSize();
var E=Math.ceil(this.__lp/z);
...
for(var F=D;F<=C;F++){if(this.__lv[F]==null||this.__lv[F].isDirty){if(B==-1){B=F;
}A=F;
}}if(B!=-1){this.__ls=-1;
this.__lt=-1;
this.__lr=B;
...
},_onRowDataLoaded:function(I){if(I!=null&&!this.__lu){var L=this.getBlockSize();
var J=Math.ceil(I.length/L);

if(J==1){this._setRowBlockData(this.__lr,I);
}else{for(var i=0;i<J;i++){var O=i*L;
var N=[];
var K=Math.min(L,I.length-O);

for(var P=0;P<K;P++){N.push(I[O+P]);
}this._setRowBlockData(this.__lr+i,N);
}}var M={firstRow:this.__lr*L,lastRow:(this.__lr+J+1)*L-1,firstColumn:0,lastColumn:this.getColumnCount()-1};
this.fireDataEvent(e,M);
}this.__lr=-1;
this.__lu=false;
if(this.__ls!=-1){this.prefetchRows(this.__ls,this.__lt);
}},_setRowBlockData:function(Q,R){if(this.__lv[Q]==null){this.__lw++;

while(this.__lw>this.getMaxCachedBlockCount()){var V;
var U=this.__lq;

for(var T in this.__lv){var S=this.__lv[T].lru;

if(S<U&&T>1){U=S;
V=T;
}}delete this.__lv[V];
this.__lw--;
}}this.__lv[Q]={lru:++this.__lq,rowDataArr:R};
...
for(var bf=bc;bf<=bb;bf++){var X=this.__lv[bf];
...
if(bf==bb-1){if(X.rowDataArr.length==0){delete this.__lv[bf];
}}else{var bd=this.__lv[bf+1];

if(bd!=null){X.rowDataArr.push(bd.rowDataArr[0]);
}else{X.isDirty=true;
}}}}
if(this.__lp!=-1){this.__lp--;
...
if(bi.lru!=this.__lq){bi.lru=++this.__lq;
}return bj;
...
}}},setEditable:function(bv){this.__ly=[];

for(var bw=0;bw<this.getColumnCount();bw++){this.__ly[bw]=bv;
}this.fireEvent(d);
},setColumnEditable:function(bx,by){if(by!=this.isColumnEditable(bx)){if(this.__ly==null){this.__ly=[];
}this.__ly[bx]=by;
this.fireEvent(d);
}},isColumnEditable:function(bz){return (this.__ly?(this.__ly[bz]==true):false);
},setColumnSortable:function(bA,bB){if(bB!=this.isColumnSortable(bA)){if(this.__lx==null){this.__lx=[];
}this.__lx[bA]=bB;
this.fireEvent(d);
}},isColumnSortable:function(bC){return (this.__lx?(this.__lx[bC]!==false):true);
},sortByColumn:function(bD,bE){if(this.__ln!=bD||this.__lo!=bE){this.__ln=bD;
this.__lo=bE;
this.clearCache();
this.fireEvent(d);
}},getSortColumnIndex:function(){return this.__ln;
},isSortAscending:function(){return this.__lo;
},setSortColumnIndexWithoutSortingData:function(bF){this.__ln=bF;
},setSortAscendingWithoutSortingData:function(bG){this.__lo=bG;
...
j.setTimeout(10000);
that=this;
res=j.callAsync(function(k){that._onRowCountLoaded(k.length);
},d,i,2,{'type':h},[e]);
},_loadRowData:function(l,m){var n=new qx.io.remote.Rpc(f,g);
n.setTimeout(10000);
res=n.callAsync(function(o){that._onRowDataLoaded(o);
},d,i,2,{'type':h},[e,c,b],l,m);
}}});
})();
...
if(!K.__lA){var M=qx.theme.manager.Color.getInstance();
K.__lA=this.self(arguments);
...
}K.__lA.stylesheet=qx.bom.Stylesheet.createElement(L);
...
for(E=y.length;E>3;E-=3){C=t+qx.locale.Number.getGroupSeparator(this.__iw)+y.substring(E-3,E)+C;
}C=y.substring(0,E)+C;
}var A=this.getPrefix()?this.getPrefix():t;
var x=this.getPostfix()?this.getPostfix():t;
var D=A+(z?r:t)+C;

if(B.length>0){D+=t+qx.locale.Number.getDecimalSeparator(this.__iw)+B;
}D+=x;
return D;
},parse:function(H){var M=qx.lang.String.escapeRegexpChars(qx.locale.Number.getGroupSeparator(this.__iw)+t);
var K=qx.lang.String.escapeRegexpChars(qx.locale.Number.getDecimalSeparator(this.__iw)+t);
...
if(!dm){this.__iw=qx.locale.Manager.getInstance().getLocale();
this.__lB=qx.locale.Manager.getInstance().bind(cl,this,cl);
}else{this.__iw=dm;
this.setLocale(dm);
}this.__lC=this.__iw;

if(dl!=null){this.__lD=dl.toString();

if(this.__lD in qx.util.format.DateFormat.ISO_MASKS){if(this.__lD===cU){this.__lE=true;
}this.__lD=qx.util.format.DateFormat.ISO_MASKS[this.__lD];
}}else{this.__lD=qx.locale.Date.getDateFormat(o,this.__iw)+dd+qx.locale.Date.getDateTimeFormat(n,cd,this.__iw);
...
if(dp._dateInstance==null||dp._dateInstance.__lD!=dn){dp._dateTimeInstance=new dp();
...
if(dr._dateInstance==null||dr._dateInstance.__lD!=dq){dr._dateInstance=new dr(dq);
}return dr._dateInstance;
},ASSUME_YEAR_2000_THRESHOLD:30,LOGGING_DATE_TIME__format:cs,ISO_MASKS:{isoDate:"yyyy-MM-dd",isoTime:"HH:mm:ss",isoDateTime:"yyyy-MM-dd'T'HH:mm:ss",isoUtcDateTime:"yyyy-MM-dd'T'HH:mm:ss'Z'"},AM_MARKER:"am",PM_MARKER:"pm"},members:{__lB:null,__iw:null,__lC:null,__lD:null,__lF:null,__lG:null,__lH:null,__lE:null,__lI:function(ds,dt){var du=cA+(ds<0?((-1)*ds):ds);

while(du.length<dt){du=bB+du;
}return ds<0?cz+du:du;
},__lJ:function(dv){var dw=new Date(dv.getTime());
var dx=dw.getDate();

while(dw.getMonth()!=0){dw.setDate(-1);
dx+=dw.getDate()+1;
}return dx;
},__lK:function(dy){return new Date(dy.getTime()+(3-((dy.getDay()+6)%7))*86400000);
},__lL:function(dz){var dB=this.__lK(dz);
var dC=dB.getFullYear();
var dA=this.__lK(new Date(dC,0,4));
return Math.floor(1.5+(dB.getTime()-dA.getTime())/86400000/7);
},__lM:function(dD){var dF=this.__lK(dD);
var dE=this.__lK(new Date(dD.getFullYear(),dD.getMonth(),4));
return Math.floor(1.5+(dF.getTime()-dE.getTime())/86400000/7);
},__lN:function(dG){var dH=this.__lK(dG);
return dH.getFullYear();
},__lO:function(dI){var dJ=new Date(dI,2,1);
dJ.setDate(-1);
return dJ.getDate()+1===29;
},__lP:function(dK,dL){var dP=0;
var dQ=0;
if(!dL){dL=1971;
}var dM=0;
...
},__lQ:function(dR,dS,dT){var dU;

switch(dS){case 11:dU=dR-1;

if(dR!=this.__lN(new Date(dU,dS,dT))){dU=dR;
}break;
case 0:dU=dR+1;
...
},_applyLocale:function(dV,dW){this.__iw=dV===null?this.setLocale(this.__lC):dV;
},format:function(dX){if(dX==null){return null;
}
if(this.__lE){dX=new Date(dX.getUTCFullYear(),dX.getUTCMonth(),dX.getUTCDate(),dX.getUTCHours(),dX.getUTCMinutes(),dX.getUTCSeconds(),dX.getUTCMilliseconds());
}var eb=this.__iw;
...
for(var i=0;i<this.__lH.length;i++){var eh=this.__lH[i];
...
switch(ea){case cf:if(el==2){et=this.__lI(eg%100,2);
...
case cL:if(el==1||el==2){et=this.__lI(parseInt(ec/4)+1,el);
}
if(el==3){et=cL+(parseInt(ec/4)+1);
}break;
case E:if(el==1||el==2){et=this.__lI(parseInt(ec/4)+1,el);
}
if(el==3){et=cL+(parseInt(ec/4)+1);
}break;
case bX:et=this.__lI(this.__lJ(dX),el);
break;
case cu:et=this.__lI(ef,el);
break;
case l:et=this.__lI(this.__lL(dX),el);
break;
case df:et=this.__lM(dX);
break;
...
if(el>=1&&el<=2){et=this.__lI(eo,el);
...
case cT:if(el==1||el==2){et=this.__lI(ec+1,el);
...
case X:if(el==1||el==2){et=this.__lI(ec+1,el);
}else if(el==3){et=qx.locale.Date.getMonthName(cy,ec,eb,cB);
}else if(el==4){et=qx.locale.Date.getMonthName(cx,ec,eb,cB);
}else if(el==5){et=qx.locale.Date.getMonthName(bG,ec,eb,cw);
}break;
...
break;
case bt:et=this.__lI(em,el);
break;
case bL:et=this.__lI((em==0)?24:em,el);
break;
case bW:et=this.__lI(em%12,el);
break;
case I:et=this.__lI(((em%12)==0)?12:(em%12),el);
break;
case cX:et=this.__lI(es,el);
break;
case Q:et=this.__lI(ek,el);
break;
case bu:et=eq+cA;
...
case q:if(el>=1&&el<=4){et=ck+((en>0)?cz:cK)+this.__lI(Math.abs(dY),2)+cP+this.__lI(ep,2);
}break;
case de:if(el>=1&&el<=3){et=((en>0)?cz:cK)+this.__lI(Math.abs(dY),2)+this.__lI(ep,2);
}else{et=ck+((en>0)?cz:cK)+this.__lI(Math.abs(dY),2)+cP+this.__lI(ep,2);
}break;
}er+=et;
}}return er;
},parse:function(eu){this.__lS();
var eD=this.__lF.regex.exec(eu);

if(eD==null){throw new Error("Date string '"+eu+"' does not match the date format: "+this.__lD);
...
for(var i=0;i<this.__lF.usedRules.length;i++){var ez=this.__lF.usedRules[i];
var eA=eD[ex];
...
for(var k=0;k<this.__lF.usedRules.length;k++){if(this.__lF.usedRules[k].pattern==cc){eB=true;
break;
}}
if(!eB){ew=true;
}}
...
for(var k=0;k<this.__lF.usedRules.length;k++){if(this.__lF.usedRules[k].pattern.indexOf(s)!=-1){eF=true;
break;
}}
if(!eF){ey=true;
}}ex+=(ez.groups==null)?1:ez.groups;
}
if(ew){ev.year=this.__lQ(ev.weekYear,ev.month,ev.day);
}
if(ey){var eE=this.__lP(ev.dayOfYear,ev.year);
ev.month=eE.month;
ev.day=eE.day;
}
...
if(this.__lE){eC=new Date(eC.getUTCFullYear(),eC.getUTCMonth(),eC.getUTCDate(),eC.getUTCHours(),eC.getUTCMinutes(),eC.getUTCSeconds(),eC.getUTCMilliseconds());
}
...
},__lR:function(){if(this.__lH!=null){return;
}this.__lH=[];
var eK;
var eI=0;
var eM=cA;
...
case bz:if(eL==eK){eI++;
i++;
}else{this.__lH.push({type:bz,character:eK,size:eI});
eK=null;
eI=0;
eJ=bC;
}break;
...
if(eJ!=bC){if(eM.length>0){this.__lH.push({type:bA,text:eM});
eM=cA;
}}else{eM+=eL;
i++;
}break;
}}if(eK!=null){this.__lH.push({type:bz,character:eK,size:eI});
}else if(eM.length>0){this.__lH.push({type:bA,text:eM});
}},__lS:function(){if(this.__lF!=null){return ;
}var eQ=this.__lD;
this.__lU();
this.__lR();
var eW=[];
...
for(var eO=0;eO<this.__lH.length;eO++){var eX=this.__lH[eO];
...
for(var eY=0;eY<this.__lG.length;eY++){var eU=this.__lG[eY];

if(this.__lT(eU,eP,eT)){eR=eU;
break;
...
}this.__lF={regex:eN,"usedRules":eW,pattern:eS};
},__lT:function(fb,fc,fd){if(fc===cf&&fb.pattern===cc){fb.regex=fb.regexFunc(fd);
return true;
}else if(fc===p&&fb.pattern===bk){fb.regex=fb.regexFunc(fd);
return true;
}else{return fc==fb.pattern.charAt(0)&&fd==fb.pattern.length;
}},__lU:function(){var fu=qx.util.format.DateFormat;
var fx=qx.lang.String;

if(this.__lG!=null){return ;
}var fv=this.__lG=[];
var fp=qx.locale.Date.getAmMarker(this.__iw).toString()||fu.AM_MARKER;
var fH=qx.locale.Date.getPmMarker(this.__iw).toString()||fu.PM_MARKER;
var fg=this.__iw;
...
}},destruct:function(){if(this.__lB!=null){qx.locale.Manager.getInstance().removeBinding(this.__lB);
}this.__lH=this.__lF=this.__lG=null;
}});
})();
...
}else{bx=this.__lV.getTerritory()||this.__lV.getLanguage();
...
qx.Mixin.define(d,{construct:function(){if(qx.core.Environment.get(l)){qx.locale.Manager.getInstance().addListener(j,this.__lW,this);
...
},__lW:qx.core.Environment.select(l,{"true":function(e){var o=this.getInvalidMessage();
...
}},"false":null})},destruct:function(){if(qx.core.Environment.get(l)){qx.locale.Manager.getInstance().removeListener(j,this.__lW,this);
}}});
})();
...
if(bl&&this.__lX){this.__mf().setStyles({"left":bm.left+bq,"top":bm.top+bq});
}
if(bn){if(this.__lX){this.__mf().setStyles({"width":innerWidth+bq,"height":innerHeight+bq});
...
if(this.__lX){if(bt){this._showPlaceholder();
...
if(this.__lX){this.__mf().setStyles(by);
}if(bw){this.__md=qx.bom.Label.getTextSize(d,by);
...
this.__md=qx.bom.Label.getTextSize(d,bH);
qx.ui.core.queue.Layout.add(this);
}},__me:function(bI){var bJ=this.__mb;
this.__mb=bI;

if(bJ!=bI){this.fireNonBubblingEvent(l,qx.event.type.Data,[bI,bJ]);
}},setValue:function(bK){if(bK===null){if(this.__lY){return bK;
}bK=j;
this.__lY=true;
...
this.removeState(k);
}},_syncPlaceholder:function(){if(this.hasState(k)){this.__mf().setStyle(bc,G);
}},__mf:function(){if(this.__ma==null){this.__ma=new qx.html.Label();
var bT=qx.theme.manager.Color.getInstance();
this.__ma.setStyles({"visibility":X,"zIndex":6,"position":W,"color":bT.resolve(O)});
...
}},"false":null}),_applyPlaceholder:function(bU,bV){if(this.__lX){this.__mf().setValue(bU);
...
}}},destruct:function(){this.__ma=this.__jF=null;
...
}},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{input:1,change:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:false},members:{__mj:false,__mk:null,__mb:null,__mc:null,canHandleEvent:function(B,C){var D=B.tagName.toLowerCase();

if(C===m&&(D===m||D===c)){return true;
}
if(C===j&&(D===m||D===c||D===p)){return true;
}return false;
},registerEvent:function(E,F,G){if(qx.core.Environment.get(k)==x&&(qx.core.Environment.get(f)<9||(qx.core.Environment.get(f)>=9&&qx.core.Environment.get(A)<9))){if(!E.__ml){var H=E.tagName.toLowerCase();
var I=E.type;
...
qx.bom.Event.addNativeListener(E,a,this._onKeyPressWrapped);
}}}}},__mm:qx.core.Environment.select(k,{"mshtml":function(J){if(qx.core.Environment.get(f)>=9&&qx.core.Environment.get(A)>=9){qx.bom.Event.addNativeListener(J,m,this._onInputWrapper);
...
}}),unregisterEvent:function(O,P){if(qx.core.Environment.get(k)==x&&qx.core.Environment.get(f)<9&&qx.core.Environment.get(A)<9){if(O.__ml){var Q=O.tagName.toLowerCase();
var R=O.type;
...
}}}},__mn:qx.core.Environment.select(k,{"mshtml":function(T){if(qx.core.Environment.get(f)>=9&&qx.core.Environment.get(A)>=9){qx.bom.Event.removeNativeListener(T,m,this._onInputWrapper);
...
}}),_onKeyPress:qx.core.Environment.select(k,{"mshtml|opera":function(e,Y){if(e.keyCode===13){if(Y.value!==this.__mb){this.__mb=Y.value;
qx.event.Registration.fireEvent(Y,j,qx.event.type.Data,[Y.value]);
}}},"default":null}),_inputFix:qx.core.Environment.select(k,{"mshtml":function(e,ba){if(e.keyCode===46||e.keyCode===8){if(ba.value!==this.__mc){this.__mc=ba.value;
...
}},properties:{spacingX:{check:h,init:0,apply:p},spacingY:{check:h,init:0,apply:p}},members:{__mq:null,__mo:null,__mp:null,__mr:null,__ms:null,__mt:null,__mu:null,__mv:null,__mw:null,verifyLayoutProperty:null,__mx:function(){var B=[];
var A=[];
var C=[];
var w=-1;
var v=-1;
...
},_setRowData:function(G,H,I){var J=this.__mo[G];

if(!J){this.__mo[G]={};
this.__mo[G][H]=I;
}else{J[H]=I;
}},_setColumnData:function(K,L,M){var N=this.__mp[K];
...
return this;
},getColumnAlign:function(S){var T=this.__mp[S]||{};
return {vAlign:T.vAlign||q,hAlign:T.hAlign||r};
},setRowAlign:function(U,V,W){this._setRowData(U,o,V);
this._setRowData(U,m,W);
this._applyLayoutChange();
return this;
},getRowAlign:function(X){var Y=this.__mo[X]||{};
return {vAlign:Y.vAlign||q,hAlign:Y.hAlign||r};
},getCellWidget:function(ba,bb){if(this._invalidChildrenCache){this.__mx();
}var ba=this.__mq[ba]||{};
return ba[bb]||null;
},getRowCount:function(){if(this._invalidChildrenCache){this.__mx();
}return this.__mt+1;
},getColumnCount:function(){if(this._invalidChildrenCache){this.__mx();
}return this.__mu+1;
},getCellAlign:function(bc,bd){var bj=q;
var bh=r;
var bi=this.__mo[bc];
var bf=this.__mp[bd];
var be=this.__mq[bc][bd];
...
for(var i=0,l=this.__ms.length;i<l;i++){var cl=this.__ms[i];
var ch=this.__my(cl);
...
for(var i=0,l=this.__mr.length;i<l;i++){var ct=this.__mr[i];
var cv=this.__my(ct);
...
for(var j=0;j<cy.colSpan;j++){cB=cA[cu+j]?cA[cu+j].offset:0;
cs[cu+j].minWidth+=cB;
}}}},_getRowHeights:function(){if(this.__mv!=null){return this.__mv;
}var cP=[];
var cI=this.__mt;
var cH=this.__mu;
...
for(var cO=0;cO<=cH;cO++){var cG=this.__mq[cQ][cO];
...
if(this.__ms.length>0){this._fixHeightsRowSpan(cP);
}this.__mv=cP;
return cP;
},_getColWidths:function(){if(this.__mw!=null){return this.__mw;
}var cV=[];
var cS=this.__mu;
var cU=this.__mt;
...
for(var dc=0;dc<=cU;dc++){var cR=this.__mq[dc][db];
...
if(this.__mr.length>0){this._fixWidthsColSpan(cV);
}this.__mw=cV;
return cV;
...
},renderLayout:function(ds,dt){if(this._invalidChildrenCache){this.__mx();
...
for(var dC=0;dC<=du;dC++){var dJ=this.__mq[dC][dP];
if(!dJ){top+=dV[dC]+dB;
continue;
...
return eb;
}},destruct:function(){this.__mq=this.__mo=this.__mp=this.__mr=this.__ms=this.__mw=this.__mv=null;
}});
})();
(function(){var k="qx.event.type.Data",j="visibilityChanged",h="orderChanged",g="visibilityChangedPre",f="__mD",e="__mE",d="__mF",c="widthChanged",b="qx.ui.table.columnmodel.Basic",a="headerCellRendererChanged";
qx.Class.define(b,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.__mz=[];
this.__mA=[];
},events:{"widthChanged":k,"visibilityChangedPre":k,"visibilityChanged":k,"orderChanged":k,"headerCellRendererChanged":k},statics:{DEFAULT_WIDTH:100,DEFAULT_HEADER_RENDERER:qx.ui.table.headerrenderer.Default,DEFAULT_DATA_RENDERER:qx.ui.table.cellrenderer.Default,DEFAULT_EDITOR_FACTORY:qx.ui.table.celleditor.TextField},members:{__lm:null,__mB:null,__mA:null,__mz:null,__mC:null,__mD:null,__mE:null,__mF:null,init:function(l,m){this.__mC=[];
var q=qx.ui.table.columnmodel.Basic.DEFAULT_WIDTH;
var r=this.__mD||(this.__mD=new qx.ui.table.columnmodel.Basic.DEFAULT_HEADER_RENDERER());
var o=this.__mE||(this.__mE=new qx.ui.table.columnmodel.Basic.DEFAULT_DATA_RENDERER());
var n=this.__mF||(this.__mF=new qx.ui.table.columnmodel.Basic.DEFAULT_EDITOR_FACTORY());
this.__mz=[];
this.__mA=[];
var t;
...
for(var u=0;u<l;u++){this.__mC[u]={width:q,headerRenderer:r,dataRenderer:o,editorFactory:n};
this.__mz[u]=u;
this.__mA[u]=u;
}this.__mB=null;
this.__lm=true;
...
}},getVisibleColumns:function(){return this.__mA!=null?this.__mA:[];
},setColumnWidth:function(v,w,y){var A=this.__mC[v].width;

if(A!=w){this.__mC[v].width=w;
var z={col:v,newWidth:w,oldWidth:A,isMouseAction:y||false};
this.fireDataEvent(c,z);
}},getColumnWidth:function(B){return this.__mC[B].width;
},setHeaderCellRenderer:function(C,D){var E=this.__mC[C].headerRenderer;

if(E!==this.__mD){E.dispose();
}this.__mC[C].headerRenderer=D;
this.fireDataEvent(a,{col:C});
},getHeaderCellRenderer:function(F){return this.__mC[F].headerRenderer;
},setDataCellRenderer:function(G,H){this.__mC[G].dataRenderer=H;
var I=this.__mC[G].dataRenderer;

if(I!==this.__mE){return I;
}return null;
},getDataCellRenderer:function(J){return this.__mC[J].dataRenderer;
},setCellEditorFactory:function(K,L){var M=this.__mC[K].headerRenderer;

if(M!==this.__mF){M.dispose();
}this.__mC[K].editorFactory=L;
},getCellEditorFactory:function(N){return this.__mC[N].editorFactory;
},_getColToXPosMap:function(){if(this.__mB==null){this.__mB={};

for(var Q=0;Q<this.__mz.length;Q++){var P=this.__mz[Q];
this.__mB[P]={overX:Q};
}
for(var O=0;O<this.__mA.length;O++){var P=this.__mA[O];
this.__mB[P].visX=O;
}}return this.__mB;
},getVisibleColumnCount:function(){return this.__mA!=null?this.__mA.length:0;
},getVisibleColumnAtX:function(R){return this.__mA[R];
},getVisibleX:function(S){return this._getColToXPosMap()[S].visX;
},getOverallColumnCount:function(){return this.__mz.length;
},getOverallColumnAtX:function(T){return this.__mz[T];
...
for(var x=bb+1;x<this.__mz.length;x++){var bd=this.__mz[x];
var Y=be[bd].visX;

if(Y!=null){bc=Y;
break;
}}if(bc==null){bc=this.__mA.length;
}this.__mA.splice(bc,0,W);
}else{var ba=this.getVisibleX(W);
this.__mA.splice(ba,1);
}this.__mB=null;
if(!this.__lm){var bf={col:W,visible:X};
this.fireDataEvent(g,bf);
this.fireDataEvent(j,bf);
}}},moveColumn:function(bg,bh){this.__lm=true;
var bk=this.__mz[bg];
var bi=this.isColumnVisible(bk);

if(bi){this.setColumnVisible(bk,false);
}this.__mz.splice(bg,1);
this.__mz.splice(bh,0,bk);
this.__mB=null;
...
},setColumnsOrder:function(bl){if(bl.length==this.__mz.length){this.__lm=true;
var bo=new Array(bl.length);

for(var bm=0;bm<this.__mz.length;bm++){var bn=this.isColumnVisible(bm);
bo[bm]=bn;

if(bn){this.setColumnVisible(bm,false);
}}this.__mz=qx.lang.Array.clone(bl);
this.__mB=null;
for(var bm=0;bm<this.__mz.length;bm++){if(bo[bm]){this.setColumnVisible(bm,true);
}}this.__lm=false;
this.fireDataEvent(h);
}else{throw new Error("setColumnsOrder: Invalid number of column positions given, expected "+this.__mz.length+", got "+bl.length);
}}},destruct:function(){for(var i=0;i<this.__mC.length;i++){this.__mC[i].headerRenderer.dispose();
this.__mC[i].dataRenderer.dispose();
this.__mC[i].editorFactory.dispose();
}this.__mz=this.__mA=this.__mC=this.__mB=null;
this._disposeObjects(f,e,d);
}});
})();
...
this.__mG=false;
this.__mH=false;
},properties:{behavior:{check:j,init:null,nullable:true,apply:h,event:b}},members:{__mH:null,__mG:null,__mI:null,_applyBehavior:function(p,q){if(q!=null){q.dispose();
q=null;
...
},_onappear:function(event){if(this.__mG){return ;
}this.__mG=true;
...
this.__mG=false;
this.__mH=true;
},_onTableWidthChanged:function(event){if(this.__mG||!this.__mH){return ;
}this.__mG=true;
this.getBehavior().onTableWidthChanged(event);
this.__mG=false;
},_onverticalscrollbarchanged:function(event){if(this.__mG||!this.__mH){return ;
}this.__mG=true;
...
this.__mG=false;
},_oncolumnwidthchanged:function(event){if(this.__mG||!this.__mH){return ;
}this.__mG=true;
this.getBehavior().onColumnWidthChanged(event);
this.__mG=false;
},_onvisibilitychanged:function(event){if(this.__mG||!this.__mH){return ;
}this.__mG=true;
...
},members:{__mJ:null,renderLayout:function(f,top,g,h){this.__mJ=g;
...
}},initializeWidthsOnEveryAppear:{check:h,init:false},tableColumnModel:{check:e}},members:{__mL:null,__mN:null,__mK:null,__mM:null,__mO:false,setWidth:function(m,n,o){if(m>=this.__mK.length){throw new Error("Column number out of range");
}this.__mK[m].setColumnWidth(n,o);
this.__mM.schedule();
},setMinWidth:function(p,q){if(p>=this.__mK.length){throw new Error("Column number out of range");
}this.__mK[p].setMinWidth(q);
this.__mM.schedule();
},setMaxWidth:function(r,s){if(r>=this.__mK.length){throw new Error("Column number out of range");
}this.__mK[r].setMaxWidth(s);
this.__mM.schedule();
...
}}},onAppear:function(event,w){if(w===true||!this.__mO||this.getInitializeWidthsOnEveryAppear()){this._computeColumnsFlexWidth();
this.__mO=true;
...
},_setNumColumns:function(y){var z=this.__mK;
...
}},properties:{alignX:{check:[m,k,c],init:m,apply:n},alignY:{check:[j,g,e],init:j,apply:n},spacing:{check:a,init:0,apply:n},separator:{check:h,nullable:true,apply:n},reversed:{check:d,init:false,apply:f}},members:{__mQ:null,__mR:null,__mS:null,__ff:null,_applyReversed:function(){this._invalidChildrenCache=true;
this._applyLayoutChange();
},__mT:function(){var w=this._getLayoutChildren();
var length=w.length;
var t=false;
var r=this.__mQ&&this.__mQ.length!=length&&this.__mR&&this.__mQ;
var u;
var s=r?this.__mQ:new Array(length);
var v=r?this.__mR:new Array(length);
...
for(i=0;i<length;i+=1){J=this.__mQ[i];
K=J!=null?Math.floor((x-B)*J):E[i].getSizeHint().width;
P.push(K);
F+=K;
}if(this.__mS&&F!=x){var H={};
var L,O;

for(i=0;i<length;i+=1){L=this.__mR[i];
...
this.__mU=new qx.ui.container.Composite(new qx.ui.layout.HBox());
this._add(this.__mU,{flex:1});
this.setDataRowRenderer(new qx.ui.table.rowrenderer.Default(this));
this.__mV=this.getNewSelectionManager()(this);
...
}}},members:{__mW:null,__mX:null,__mU:null,__mV:null,__na:null,__nb:null,__lm:null,__nc:null,__nd:null,__ne:null,__nf:null,__je:null,_createChildControlImpl:function(bS,bT){var bU;
...
},_applySelectionModel:function(bW,bX){this.__mV.setSelectionModel(bW);
...
for(var i=0;i<ce.length;i++){ce[i]._excludeChildControl(bt);
...
}},getEmptyTableModel:function(){if(!this.__ne){this.__ne=new qx.ui.table.model.Simple();
this.__ne.setColumns([]);
this.__ne.setData([]);
}return this.__ne;
...
}},getTableColumnModel:function(){if(!this.__nd){var cn=this.__nd=this.getNewTableColumnModel()(this);
...
}},_applyAdditionalStatusBarText:function(cr,cs){this.__na=cr;
this._updateStatusBar();
...
for(var cG in qx.ui.table.Table.__mY){cB[cG]={};
...
for(cG in qx.ui.table.Table.__mY){if(!cB[cG]){break;
}
...
}},getSelectionManager:function(){return this.__mV;
},_getPaneScrollerArr:function(){return this.__mU.getChildren();
...
if(this.__mX>=dq&&this.__mX<(dq+dr)){this.setFocusedCell();
}}
for(var i=0;i<ds.length;i++){ds[i].onTableModelDataChanged(dl,dm,dn,dp);
}var dt=this.getTableModel().getRowCount();

if(dt!=this.__nb){this.__nb=dt;
this._updateScrollBarVisibility();
this._updateStatusBar();
}},_onScrollY:function(du){if(!this.__lm){this.__lm=true;
...
if(this.__mX!=dD){dA=this.startEditing();
}break;
...
default:dA=false;
break;
}}else{switch(dE){case I:this.__mV.handleSelectKeyDown(this.__mX,dw);
break;
case b:case bC:this.startEditing();
dA=true;
break;
case C:this.setFocusedCell(this.__mW,0,true);
break;
case bc:var dB=this.getTableModel().getRowCount();
this.setFocusedCell(this.__mW,dB-1,true);
break;
...
if(dD!=this.__mX&&this.getRowFocusChangeModifiesSelection()){this.__mV.handleMoveKeyDown(this.__mX,dw);
}
...
if(this.__nc!=null&&dJ.col!=null&&dJ.visible!=null){this.__nc[dJ.col].setVisible(dJ.visible);
}this._updateScrollerWidths();
this._updateScrollBarVisibility();
...
},setFocusedCell:function(dR,dS,dT){if(!this.isEditing()&&(dR!=this.__mW||dS!=this.__mX)){if(dR===null){dR=0;
}this.__mW=dR;
this.__mX=dS;
...
},getFocusedColumn:function(){return this.__mW;
},getFocusedRow:function(){return this.__mX;
...
}},moveFocusedCell:function(ea,eb){var ef=this.__mW;
var eg=this.__mX;
...
}},isEditing:function(){if(this.__mW!=null){var x=this.getTableColumnModel().getVisibleX(this.__mW);
var em=this._getMetaColumnAtColumnX(x);
return this.getPaneScroller(em).isEditing();
}return false;
},startEditing:function(){if(this.__mW!=null){var x=this.getTableColumnModel().getVisibleX(this.__mW);
var eo=this._getMetaColumnAtColumnX(x);
var en=this.getPaneScroller(eo).startEditing();
return en;
}return false;
},stopEditing:function(){if(this.__mW!=null){var x=this.getTableColumnModel().getVisibleX(this.__mW);
var ep=this._getMetaColumnAtColumnX(x);
this.getPaneScroller(ep).stopEditing();
}},cancelEditing:function(){if(this.__mW!=null){var x=this.getTableColumnModel().getVisibleX(this.__mW);
...
if(this.__na){if(eD){eD+=this.__na;
}else{eD=this.__na;
}}
...
if(eP){if(this.__nf==null){this.__nf=eJ[i].getVerticalScrollBarVisible();
this.__je=qx.event.Timer.once(function(){this.__nf=null;
this.__je=null;
},this,0);
}}eJ[i].setVerticalScrollBarVisible(eP&&eN);
if(eP&&eN!=this.__nf){this.fireDataEvent(bf,eN);
...
this._updateScrollerWidths();
this._updateScrollBarVisibility();
},addListener:function(fd,fe,self,ff){if(this.self(arguments).__mY[fd]){var fh=[fd];
...
}},removeListener:function(fi,fj,self,fk){if(this.self(arguments).__mY[fi]){for(var i=0,fl=this._getPaneScrollerArr();i<fl.length;i++){fl[i].removeListener.apply(fl[i],arguments);
}}else{qx.ui.core.Widget.prototype.removeListener.call(this,fi,fj,self,fk);
}},removeListenerById:function(fm){var fq=fm.split(bD);
var fp=fq.shift();

if(this.self(arguments).__mY[fp]){var fo=true;
...
this._disposeObjects(bj,H,bG,bG,be,N);
this._disposeMap(U);
}});
})();
...
if(q){this.setSeparator(q);
}},properties:{alignY:{check:[m,j,e],init:m,apply:n},alignX:{check:[k,g,a],init:k,apply:n},spacing:{check:c,init:0,apply:n},separator:{check:h,nullable:true,apply:n},reversed:{check:b,init:false,apply:f}},members:{__ng:null,__mR:null,__mS:null,__ff:null,_applyReversed:function(){this._invalidChildrenCache=true;
this._applyLayoutChange();
},__mT:function(){var w=this._getLayoutChildren();
var length=w.length;
var s=false;
var r=this.__ng&&this.__ng.length!=length&&this.__mR&&this.__ng;
var u;
var t=r?this.__ng:new Array(length);
var v=r?this.__mR:new Array(length);
if(this.getReversed()){w=w.concat().reverse();
}for(var i=0;i<length;i++){u=w[i].getLayoutProperties();
...
for(i=0;i<length;i+=1){J=this.__ng[i];
B=J!=null?Math.floor((y-C)*J):F[i].getSizeHint().height;
K.push(B);
Q+=B;
}if(this.__mS&&Q!=y){var H={};
var N,R;

for(i=0;i<length;i+=1){N=this.__mR[i];
...
}},destruct:function(){this.__ng=this.__mR=this.__ff=null;
}});
})();
...
},properties:{highlightFocusRow:{check:h,init:true}},members:{_colors:null,__ni:null,__nh:null,_insetY:1,_renderFont:function(x){if(x){this.__ni=x.getStyles();
this.__nh=qx.bom.element.Style.compile(this.__ni);
this.__nh=this.__nh.replace(/"/g,d);
}else{this.__nh=j;
this.__ni=qx.bom.Font.getDefaultStyles();
}},updateDataRowElement:function(y,z){var B=this.__ni;
var A=z.style;
...
}},destruct:function(){this._colors=this.__ni=this.__nh=null;
}});
})();
...
(function(){var u="keypress",t="interval",s="keydown",r="mousedown",q="keyup",p="__jB",o="blur",n="Enter",m="__nk",l="Up",d="__nj",k="Escape",h="event.touch",c="qx.ui.menu.Manager",b="Left",g="Down",f="Right",j="singleton",a="Space";
...
this.__nj.addListener(t,this._onOpenInterval,this);
this.__nk=new qx.event.Timer;
this.__nk.addListener(t,this._onCloseInterval,this);
},members:{__nl:null,__nm:null,__nj:null,__nk:null,__jB:null,_getChild:function(x,y,z,A){var B=x.getChildren();
var length=B.length;
var C;
...
if(L.isVisible()){if(this.__nl){this.cancelOpen(this.__nl);
}}else if(this.__nl!=L){this.__nl=L;
this.__nj.restartWith(L.getOpenInterval());
}},scheduleClose:function(M){this.cancelOpen(M);
if(!M.isVisible()){if(this.__nm){this.cancelClose(this.__nm);
}}else if(this.__nm!=M){this.__nm=M;
this.__nk.restartWith(M.getCloseInterval());
}},cancelOpen:function(N){if(this.__nl==N){this.__nj.stop();
this.__nl=null;
}},cancelClose:function(O){if(this.__nm==O){this.__nk.stop();
this.__nm=null;
}},_onOpenInterval:function(e){this.__nj.stop();
this.__nl.open();
this.__nl=null;
},_onCloseInterval:function(e){this.__nk.stop();
this.__nm.exclude();
this.__nm=null;
...
}},__nn:{"Enter":1,"Space":1},__no:{"Escape":1,"Up":1,"Down":1,"Left":1,"Right":1},_onKeyUpDown:function(e){var Q=this.getActiveMenu();

if(!Q){return;
}var R=e.getKeyIdentifier();

if(this.__no[R]||(this.__nn[R]&&Q.getSelectedButton())){e.stopPropagation();
...
qx.Mixin.define(b,{members:{__np:function(m,n,o,p){var q=this.getChildrenContainer();

if(q===this){m=h+m;
}return (q[m])(n,o,p);
},getChildren:function(){return this.__np(c);
},hasChildren:function(){return this.__np(f);
},add:function(r,s){return this.__np(j,r,s);
},remove:function(t){return this.__np(a,t);
},removeAll:function(){return this.__np(d);
},indexOf:function(u){return this.__np(l,u);
},addAt:function(v,w,x){this.__np(g,v,w,x);
},addBefore:function(y,z,A){this.__np(i,y,z,A);
},addAfter:function(B,C,D){this.__np(k,B,C,D);
},removeAt:function(E){return this.__np(e,E);
}}});
})();
...
},__ns:function(){if(this.isVisible()){if(this.getBlockBackground()){var R=this.getZIndex();
...
},__nt:function(){var bj=this._getMenuBounds();

if(!bj){this.addListenerOnce(j,this.__nt,this);
return;
...
if(this.__nr){this.__nr.call(this);
delete this.__nr;
...
if(this.__nq){bo.cancelOpen(this.__nq);
this.__nq=null;
...
}if(this.__nq){br.cancelOpen(this.__nq);
...
qx.Class.define(a,{extend:qx.ui.layout.VBox,properties:{columnSpacing:{check:c,init:0,apply:b},spanColumn:{check:c,init:1,nullable:true,apply:b},iconColumnWidth:{check:c,init:0,themeable:true,apply:b},arrowColumnWidth:{check:c,init:0,themeable:true,apply:b}},members:{__nu:null,_computeSizeHint:function(){var q=this._getLayoutChildren();
var o,g,j;
var e=this.getSpanColumn();
var h=this.__nu=[0,0,0,0];
...
},getColumnSizes:function(){return this.__nu||null;
...
}},__nv:function(t){while(!(t instanceof qx.ui.menu.Menu)){t=t.getLayoutParent();
}return t;
...
},events:{"execute":j,"press":j,"release":j},properties:{interval:{check:l,init:100},firstInterval:{check:l,init:500},minTimer:{check:l,init:20},timerDecrease:{check:l,init:2}},members:{__nw:null,__je:null,press:function(){if(this.isEnabled()){if(!this.hasState(n)){this.__nx();
}this.removeState(m);
this.addState(n);
}},release:function(q){if(!this.isEnabled()){return;
}if(this.hasState(n)){if(!this.__nw){this.execute();
}}this.removeState(n);
this.removeState(m);
this.__ny();
...
if(this.hasState(n)&&!this.__nw){this.execute();
}}this.__ny();
e.stopPropagation();
},_onKeyUp:function(e){switch(e.getKeyIdentifier()){case i:case h:if(this.hasState(n)){if(!this.__nw){this.execute();
}this.removeState(n);
this.removeState(m);
e.stopPropagation();
this.__ny();
...
e.stopPropagation();
this.__nx();
}},_onInterval:function(e){this.__nw=true;
this.fireEvent(b);
},__nx:function(){this.fireEvent(g);
this.__nw=false;
...
this.removeState(m);
this.addState(n);
},__ny:function(){this.fireEvent(d);
this.__je.stop();
this.removeState(m);
this.removeState(n);
...
},events:{"interval":b},properties:{interval:{check:e,init:100},firstInterval:{check:e,init:500},minimum:{check:e,init:20},decrease:{check:e,init:2}},members:{__je:null,__nz:null,start:function(){this.__je.setInterval(this.getFirstInterval());
this.__je.start();
},stop:function(){this.__je.stop();
this.__nz=null;
},_onInterval:function(){this.__je.stop();

if(this.__nz==null){this.__nz=this.getInterval();
}this.__nz=Math.max(this.getMinimum(),this.__nz-this.getDecrease());
this.__je.setInterval(this.__nz);
this.__je.start();
this.fireEvent(d);
}},destruct:function(){this._disposeObjects(c);
}});
...
}else if(this.__nA.length>0){do{var M=this.__nA[0];
...
var K=false;
if(this.__nA.length==1&&I>0){var D=L-this.getSpacing();
var H=B-I+F+D;
K=A>H;
}if(A>B+F+L||K){this.__nC(M);
B+=F;
if(C&&this.__nA.length==0){C.setVisibility(v);
}}else{return;
}}}while(A>=B&&this.__nA.length>0);
}},__nC:function(N){N.setVisibility(w);
this.__nA.shift();
this.fireDataEvent(p,N);
},__nD:function(O){if(!O){return;
}this.__nA.unshift(O);
O.setVisibility(v);
this.fireDataEvent(j,O);
},_getNextToHide:function(){for(var i=this.__nB.length-1;i>=0;i--){var P=this.__nB[i];
...
}}},setRemovePriority:function(S,T,U){if(!U&&this.__nB[T]!=undefined){throw new Error("Priority already in use!");
}this.__nB[T]=S;
...
}for(var i=0;i<this.__nA.length;i++){this.__nA[i].setVisibility(w);
}this.__nA=[];
...
}},__nE:false,_setAllowMenuOpenHover:function(bc){this.__nE=bc;
},_isAllowMenuOpenHover:function(){return this.__nE;
...
},members:{__nc:null,__jU:null,factory:function(g,h){switch(g){case a:var j=new qx.ui.menu.Menu();
this.setMenu(j);
return j;
...
},members:{__nG:false,_applyVisible:function(h,i){if(!this.bInListener){this.setValue(h);
}}}});
})();
(function(){var b="qx.ui.table.selection.Model",a="qx.ui.table.selection.Manager";
qx.Class.define(a,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
},properties:{selectionModel:{check:b}},members:{__nH:null,handleMouseDown:function(c,d){if(d.isLeftPressed()){var e=this.getSelectionModel();
...
}}},handleMouseUp:function(f,g){if(g.isLeftPressed()&&!this.__nH){this._handleSelectEvent(f,g);
...
this.__nL=false;
},events:{"changeSelection":f},statics:{NO_SELECTION:1,SINGLE_SELECTION:2,SINGLE_INTERVAL_SELECTION:3,MULTIPLE_INTERVAL_SELECTION:4,MULTIPLE_INTERVAL_SELECTION_TOGGLE:5},properties:{selectionMode:{init:2,check:[1,2,3,4,5],apply:a}},members:{__nL:null,__nJ:null,__nK:null,__nI:null,_applySelectionMode:function(o){this.resetSelection();
},setBatchMode:function(p){if(p){this.hasBatchModeRefCount+=1;
}else{if(this.hasBatchModeRefCount==0){throw new Error("Try to turn off batch mode althoug it was not turned on.");
}this.hasBatchModeRefCount-=1;

if(this.__nL){this.__nL=false;
this._fireChangeSelection();
}}return this.hasBatchMode();
},hasBatchMode:function(){return this.hasBatchModeRefCount>0;
},getAnchorSelectionIndex:function(){return this.__nJ;
},_setAnchorSelectionIndex:function(q){this.__nJ=q;
},getLeadSelectionIndex:function(){return this.__nK;
},_setLeadSelectionIndex:function(r){this.__nK=r;
},_getSelectedRangeArr:function(){return this.__nI;
},resetSelection:function(){if(!this.isSelectionEmpty()){this._resetSelection();
this._fireChangeSelection();
}},isSelectionEmpty:function(){return this.__nI.length==0;
},getSelectedCount:function(){var t=0;

for(var i=0;i<this.__nI.length;i++){var s=this.__nI[i];
t+=s.maxIndex-s.minIndex+1;
}return t;
},isSelectedIndex:function(u){for(var i=0;i<this.__nI.length;i++){var v=this.__nI[i];

if(u>=v.minIndex&&u<=v.maxIndex){return true;
}}return false;
},getSelectedRanges:function(){var w=[];

for(var i=0;i<this.__nI.length;i++){w.push({minIndex:this.__nI[i].minIndex,maxIndex:this.__nI[i].maxIndex});
}return w;
},iterateSelection:function(x,y){for(var i=0;i<this.__nI.length;i++){for(var j=this.__nI[i].minIndex;j<=this.__nI[i].maxIndex;j++){x.call(y,j);
...
break;
}},removeSelectionInterval:function(F,G){this.__nJ=F;
this.__nK=G;
var H=Math.min(F,G);
var J=Math.max(F,G);
for(var i=0;i<this.__nI.length;i++){var L=this.__nI[i];

if(L.minIndex>J){break;
}else if(L.maxIndex>=H){var M=(L.minIndex>=H)&&(L.minIndex<=J);
var K=(L.maxIndex>=H)&&(L.maxIndex<=J);

if(M&&K){this.__nI.splice(i,1);
i--;
}else if(M){L.minIndex=J+1;
}else if(K){L.maxIndex=H-1;
}else{var I={minIndex:J+1,maxIndex:L.maxIndex};
this.__nI.splice(i+1,0,I);
L.maxIndex=H-1;
break;
}}}this._fireChangeSelection();
},_resetSelection:function(){this.__nI=[];
this.__nJ=-1;
this.__nK=-1;
},_addSelectionInterval:function(N,O){this.__nJ=N;
this.__nK=O;
var P=Math.min(N,O);
var R=Math.max(N,O);
var Q=0;

for(;Q<this.__nI.length;Q++){var S=this.__nI[Q];

if(S.minIndex>P){break;
}}this.__nI.splice(Q,0,{minIndex:P,maxIndex:R});
var T=this.__nI[0];

for(var i=1;i<this.__nI.length;i++){var S=this.__nI[i];

if(T.maxIndex+1>=S.minIndex){T.maxIndex=Math.max(T.maxIndex,S.maxIndex);
this.__nI.splice(i,1);
i--;
}else{T=S;
}}},_dumpRanges:function(){var U=d;

for(var i=0;i<this.__nI.length;i++){var V=this.__nI[i];
U+=k+V.minIndex+m+V.maxIndex+n;
}this.debug(U);
},_fireChangeSelection:function(){if(this.hasBatchMode()){this.__nL=true;
...
this.__nb=0;
this.__nO=[];
},events:{"paneReloadsData":b,"paneUpdated":z},properties:{firstVisibleRow:{check:j,init:0,apply:o},visibleRowCount:{check:j,init:0,apply:w},maxCacheLines:{check:j,init:1000,apply:C},allowShrinkX:{refine:true,init:false}},members:{__nb:null,__nN:null,__nM:null,__nP:null,__mX:null,__mW:null,__nO:null,__nQ:0,_applyFirstVisibleRow:function(G,H){this.updateContent(false,G-H);
},_applyVisibleRowCount:function(I,J){this.updateContent(true);
},_getContentHint:function(){return {width:this.getPaneScroller().getTablePaneModel().getTotalWidth(),height:400};
},getPaneScroller:function(){return this.__nM;
},getTable:function(){return this.__nM.getTable();
},setFocusedCell:function(K,L,M){if(K!=this.__mW||L!=this.__mX){var N=this.__mX;
this.__mW=K;
this.__mX=L;
...
},onTableModelDataChanged:function(Q,R,S,T){this.__nR();
var V=this.getFirstVisibleRow();
var U=this.getVisibleRowCount();

if(R==-1||R>=V&&Q<V+U){this.updateContent();
}},onTableModelMetaDataChanged:function(){this.updateContent(true);
},_applyMaxCacheLines:function(W,X){if(this.__nQ>=W&&W!==-1){this.__nR();
}},__nR:function(){this.__nO=[];
this.__nQ=0;
},__nS:function(Y,ba,bb){if(!ba&&!bb&&this.__nO[Y]){return this.__nO[Y];
}else{return null;
}},__nT:function(bc,bd,be,bf){var bg=this.getMaxCacheLines();

if(!be&&!bf&&!this.__nO[bc]&&bg>0){this._applyMaxCacheLines(bg);
this.__nO[bc]=bd;
this.__nQ+=1;
}},updateContent:function(bh,bi,bj,bk){if(bh){this.__nR();
...
bz.push({col:bY,xPos:x,editable:bA.isColumnEditable(bY),focusedCol:this.__mW==bY,styleLeft:bC,styleWidth:bF});
bC+=bF;
}var bX=[];
var ca=false;
...
}}if(!this.__nP){this.__nP=document.createElement(E);
}var ck=e;
ck+=this._getRowsHtml(ci+ce,Math.abs(cb));
ck+=h;
this.__nP.innerHTML=ck;
var cf=this.__nP.firstChild.childNodes;
...
}}if(this.__mX!==null){this._updateRowStyles(this.__mX-cb);
this._updateRowStyles(this.__mX);
}this.fireEvent(f);
...
this.__nb=cq;
this.fireEvent(f);
}},destruct:function(){this.__nP=this.__nM=this.__nO=null;
}});
})();
(function(){var e="first",d="last",c="hovered",b="__nM",a="qx.ui.table.pane.Header";
qx.Class.define(a,{extend:qx.ui.core.Widget,construct:function(f){qx.ui.core.Widget.call(this);
this._setLayout(new qx.ui.layout.HBox());
this.__jU=new qx.ui.core.Blocker(this);
this.__nM=f;
},members:{__nM:null,__nU:null,__nV:null,__jU:null,getPaneScroller:function(){return this.__nM;
},getTable:function(){return this.__nM.getTable();
},getBlocker:function(){return this.__jU;
...
}},setMouseOverColumn:function(k){if(k!=this.__nV){if(this.__nV!=null){var l=this.getHeaderWidgetAtColumn(this.__nV);
...
if(this.__nU==null){var y=this.getTable();
...
this.__nU=q;
}this.__nU.setLayoutProperties({left:s.left+x});
this.__nU.show();
},hideColumnMoveFeedback:function(){if(this.__nU!=null){this.__nU.destroy();
this.__nU=null;
}},isShowingColumnMoveFeedback:function(){return this.__nU!=null;
...
var bn=this.__oa=qx.bom.element.Location.get(this.getContentElement().getDomElement())[bj];
var bl=this.__ob=qx.bom.element.Location.get(bi.getContainerElement().getDomElement())[bj];

if(e.getTarget()===bi){this.__od=true;

if(!this.__oi){this.__oi=new qx.event.Timer(100);
this.__oi.addListener(W,this._fireValue,this);
}this.__oi.start();
this.__oe=bm+bn-bl;
bi.addState(b);
}else{this.__of=true;
...
if(this.__nW){bp=e.getDocumentLeft()-(this._valueToPosition(this.getValue())+this.__oa);
...
}else{bp=e.getDocumentTop()-(this._valueToPosition(this.getValue())+this.__oa);
...
if(bq<0||bq>this.__oc||bp<0||bp>this.__oc){this.getChildControl(k).removeState(g);
}}}else if(this.__of){this.__je.stop();
this.releaseCapture();
delete this.__of;
delete this.__og;
delete this.__oh;
...
}},_onMouseMove:function(e){if(this.__od){var bs=this.__nW?e.getDocumentLeft():e.getDocumentTop();
var br=bs-this.__oe;
this.slideTo(this._positionToValue(br));
}else if(this.__of){this.__om(e);
}e.stopPropagation();
},_onInterval:function(e){var bt=this.getValue()+(this.__og*this.getPageStep());
if(bt<this.getMinimum()){bt=this.getMinimum();
}else if(bt>this.getMaximum()){bt=this.getMaximum();
}var bu=this.__og==-1;

if((bu&&bt<=this.__oh)||(!bu&&bt>=this.__oh)){bt=this.__oh;
}this.slideTo(bt);
},_onUpdate:function(e){var bw=this.getInnerSize();
var bx=this.getChildControl(k).getBounds();
var bv=this.__nW?E:C;
this._updateKnobSize();
this.__ol=bw[bv]-bx[bv];
this.__oc=bx[bv];
this._updateKnobPosition();
},__nW:false,__ol:0,__om:function(e){var by=this.__nW;
...
var bI=this.__og<0?N:z;
bD=bE+(Math[bI]((bD-bE)/bC)*bC);
}if(this.__oh==null||(this.__og==-1&&bD<=this.__oh)||(this.__og==1&&bD>=this.__oh)){this.__oh=bD;
}},_positionToValue:function(bK){var bL=this.__ol;
...
},_valueToPosition:function(bO){var bP=this.__ol;
...
if(this.__od){this.__ok=[ce,cf];
}else{this.fireEvent(X,qx.event.type.Data,[ce,cf]);
}}else{this.resetValue();
}},_fireValue:function(){if(!this.__ok){return;
}var cg=this.__ok;
this.__ok=null;
...
(function(){var m="Boolean",l="resize-line",k="mousedown",j="qx.event.type.Data",i="mouseup",h="qx.ui.table.pane.CellEvent",g="scroll",d="focus-indicator",c="excluded",b="scrollbar-y",bo="table-scroller-focus-indicator",bn="visible",bm="mousemove",bl="header",bk="editing",bj="click",bi="modelChanged",bh="scrollbar-x",bg="cellClick",bf="pane",t="__on",u="mouseout",r="changeHorizontalScrollBarVisible",s="bottom",p="_applyScrollTimeout",q="changeScrollX",n="_applyTablePaneModel",o="Integer",A="__oq",B="dblclick",K="__ot",H="dataEdited",S="__je",N="mousewheel",bb="interval",X="qx.ui.table.pane.Scroller",D="__or",be="_applyShowCellFocusIndicator",bd="y",bc="resize",C="vertical",F="__oo",G="changeScrollY",J="appear",L="__os",O="table-scroller",U="beforeSort",ba="cellDblclick",v="__op",w="__ou",E="horizontal",R="losecapture",Q="contextmenu",P="col-resize",W="disappear",V="_applyVerticalScrollBarVisible",M="_applyHorizontalScrollBarVisible",T="cellContextmenu",a="close",Y="changeTablePaneModel",y="x",z="qx.ui.table.pane.Model",I="changeVerticalScrollBarVisible";
...
this.__oo=this._showChildControl(b);
this.__op=this._showChildControl(bl);
this.__oq=this._showChildControl(bf);
this.__or=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({minWidth:0});
this._add(this.__or,{row:0,column:0,colSpan:2});
this.__os=new qx.ui.table.pane.Clipper();
this.__os.add(this.__op);
this.__os.addListener(R,this._onChangeCaptureHeader,this);
this.__os.addListener(bm,this._onMousemoveHeader,this);
this.__os.addListener(k,this._onMousedownHeader,this);
this.__os.addListener(i,this._onMouseupHeader,this);
this.__os.addListener(bj,this._onClickHeader,this);
this.__or.add(this.__os,{flex:1});
this.__ot=new qx.ui.table.pane.Clipper();
this.__ot.add(this.__oq);
this.__ot.addListener(N,this._onMousewheel,this);
this.__ot.addListener(bm,this._onMousemovePane,this);
this.__ot.addListener(k,this._onMousedownPane,this);
this.__ot.addListener(i,this._onMouseupPane,this);
this.__ot.addListener(bj,this._onClickPane,this);
this.__ot.addListener(Q,this._onContextMenu,this);
this.__ot.addListener(B,this._onDblclickPane,this);
this.__ot.addListener(bc,this._onResizePane,this);
this._add(this.__ot,{row:1,column:0});
this.__ou=this.getChildControl(d);
...
},_applyHorizontalScrollBarVisible:function(bz,bA){this.__on.setVisibility(bz?bn:c);
},_applyVerticalScrollBarVisible:function(bB,bC){this.__oo.setVisibility(bB?bn:c);
...
},_applyShowCellFocusIndicator:function(bF,bG){if(bF){this.__ou.setDecorator(bo);
this._updateFocusIndicator();
}else{if(this.__ou){this.__ou.setDecorator(null);
}}},getScrollY:function(){return this.__oo.getPosition();
},setScrollY:function(scrollY,bH){this.__oo.scrollTo(scrollY);

if(bH){this._updateContent();
}},getScrollX:function(){return this.__on.getPosition();
},setScrollX:function(scrollX){this.__on.scrollTo(scrollX);
},getTable:function(){return this.__mI;
},onColVisibilityChanged:function(){this.updateHorScrollBarMaximum();
this._updateFocusIndicator();
},setColumnWidth:function(bI,bJ){this.__op.setColumnWidth(bI,bJ);
this.__oq.setColumnWidth(bI,bJ);
var bK=this.getTablePaneModel();
var x=bK.getX(bI);

if(x!=-1){this.updateHorScrollBarMaximum();
this._updateFocusIndicator();
}},onColOrderChanged:function(){this.__op.onColOrderChanged();
this.__oq.onColOrderChanged();
this.updateHorScrollBarMaximum();
},onTableModelDataChanged:function(bL,bM,bN,bO){this.__oq.onTableModelDataChanged(bL,bM,bN,bO);
var bP=this.getTable().getTableModel().getRowCount();

if(bP!=this.__nb){this.updateVerScrollBarMaximum();

if(this.getFocusedRow()>=bP){if(bP==0){this.setFocusedCell(null,null);
}else{this.setFocusedCell(this.getFocusedColumn(),bP-1);
}}this.__nb=bP;
}},onSelectionChanged:function(){this.__oq.onSelectionChanged();
},onFocusChanged:function(){this.__oq.onFocusChanged();
},onTableModelMetaDataChanged:function(){this.__op.onTableModelMetaDataChanged();
this.__oq.onTableModelMetaDataChanged();
},_onPaneModelChanged:function(){this.__op.onPaneModelChanged();
this.__oq.onPaneModelChanged();
},_onResizePane:function(){this.updateHorScrollBarMaximum();
this.updateVerScrollBarMaximum();
this._updateContent();
this.__op._updateContent();
this.__mI._updateScrollBarVisibility();
},updateHorScrollBarMaximum:function(){var bT=this.__ot.getInnerSize();
...
bS.setKnobFactor(1);
bS.setPosition(0);
}},updateVerScrollBarMaximum:function(){var cd=this.__ot.getInnerSize();
...
this.__os.scrollToX(ce);
this.__ot.scrollToX(ce);
...
}var ci=e.getWheelDelta(bd);
if(ci>0&&ci<1){ci=1;
}else if(ci<0&&ci>-1){ci=-1;
}this.__oo.scrollBySteps(ci);
ci=e.getWheelDelta(y);
if(ci>0&&ci<1){ci=1;
}else if(ci<0&&ci>-1){ci=-1;
}this.__on.scrollBySteps(ci);
if(this.__oJ&&this.getFocusCellOnMouseMove()){this._focusCellAtPagePos(this.__oJ,this.__oK);
}var ch=this.__oo.getPosition();
var cg=this.__oo.getMaximum();
if(ci<0&&ch<=0||ci>0&&ch>=cg){return;
}e.stop();
},__oO:function(cj){var co=this.getTable();
var cp=this.__op.getHeaderWidgetAtColumn(this.__oD);
var ck=cp.getSizeHint().minWidth;
var cm=Math.max(ck,this.__oF+cj-this.__oE);

if(this.getLiveResize()){var cl=co.getTableColumnModel();
cl.setColumnWidth(this.__oD,cm,true);
}else{this.__op.setColumnWidth(this.__oD,cm,true);
var cn=this.getTablePaneModel();
this._showResizeLine(cn.getColumnLeft(this.__oD)+cm);
}this.__oE+=cm-this.__oF;
this.__oF=cm;
},__oP:function(cq){var cr=qx.ui.table.pane.Scroller.CLICK_TOLERANCE;

if(this.__op.isShowingColumnMoveFeedback()||cq>this.__oC+cr||cq<this.__oC-cr){this.__oz+=cq-this.__oC;
this.__op.showColumnMoveFeedback(this.__oy,this.__oz);
var cs=this.__mI.getTablePaneScrollerAtPageX(cq);

if(this.__oB&&this.__oB!=cs){this.__oB.hideColumnMoveFeedback();
}
if(cs!=null){this.__oA=cs.showColumnMoveFeedback(cq);
}else{this.__oA=null;
}this.__oB=cs;
this.__oC=cq;
...
if(this.__oD!=null){this.__oO(cx);
cA=true;
e.stopPropagation();
}else if(this.__oy!=null){this.__oP(cx);
e.stopPropagation();
...
this.setCursor(cv);
this.__op.setMouseOverColumn(ct);
...
}}this.__op.setMouseOverColumn(null);
...
this.__oD=cJ;
this.__oE=cK;
this.__oF=cL.getColumnWidth(this.__oD);
this.__os.capture();
},_startMoveHeader:function(cM,cN){this.__oy=cM;
this.__oC=cN;
this.__oz=this.getTablePaneModel().getColumnLeft(cM);
this.__os.capture();
...
if(cT!==null){this.__oG={row:cT,col:cS};
this.__oH=false;
...
if(!cP){cR.getSelectionManager().handleMouseDown(cT,e);
}}},_onMouseupFocusIndicator:function(e){if(this.__oG&&!this.__oH&&!this.isEditing()&&this.__ou.getRow()==this.__oG.row&&this.__ou.getColumn()==this.__oG.col){this.fireEvent(bg,qx.ui.table.pane.CellEvent,[this,e,this.__oG.row,this.__oG.col],true);
this.__oH=true;
}else if(!this.isEditing()){this._onMousedownPane(e);
}},_onChangeCaptureHeader:function(e){if(this.__oD!=null){this._stopResizeHeader();
}
if(this.__oy!=null){this._stopMoveHeader();
}},_stopResizeHeader:function(){var cU=this.getTable().getTableColumnModel();
if(!this.getLiveResize()){this._hideResizeLine();
cU.setColumnWidth(this.__oD,this.__oF,true);
}this.__oD=null;
this.__os.releaseCapture();
this.getApplicationRoot().setGlobalCursor(null);
this.setCursor(null);
if(this.isEditing()){var cV=this.__oL.getBounds().height;
this.__oL.setUserBounds(0,0,this.__oF,cV);
}},_stopMoveHeader:function(){var db=this.getTable().getTableColumnModel();
var dc=this.getTablePaneModel();
this.__op.hideColumnMoveFeedback();

if(this.__oB){this.__oB.hideColumnMoveFeedback();
}
if(this.__oA!=null){var de=dc.getFirstColumnX()+dc.getX(this.__oy);
var da=this.__oA;
...
if(this.__oD!=null){this._stopResizeHeader();
this.__oI=true;
e.stop();
}else if(this.__oy!=null){this._stopMoveHeader();
e.stop();
}},_onClickHeader:function(e){if(this.__oI){this.__oI=false;
return;
...
if(this.fireDataEvent(U,dp,null,true)){dk.sortByColumn(dq,dn);
...
if(this.__ou.isHidden()||(this.__oG&&!this.__oH&&!this.isEditing()&&ds==this.__oG.row&&dt==this.__oG.col)){this.fireEvent(bg,qx.ui.table.pane.CellEvent,[this,e,ds,dt],true);
this.__oH=true;
...
if(!this.getShowCellFocusIndicator()||dx===null||(this.__oG&&dx==this.__oG.row&&dy==this.__oG.col)){this.fireEvent(T,qx.ui.table.pane.CellEvent,[this,e,dx,dy],true);
...
}if(this.__oD==null){this.setCursor(null);
this.getApplicationRoot().setGlobalCursor(null);
}this.__op.setMouseOverColumn(null);
},_showResizeLine:function(x){var dG=this._showChildControl(l);
var dF=dG.getWidth();
var dH=this.__ot.getBounds();
...
var dL=this.__oq.getContainerLocation().left;
...
dM=dJ+1;
dK=dU-dL;
}var dO=this.__ot.getContainerLocation().left;
var dT=this.__ot.getBounds().width;
var scrollX=dO-dL;
...
this.__mI.setFocusedCell(dX,dY);
}},setFocusedCell:function(ea,eb){if(!this.isEditing()){this.__oq.setFocusedCell(ea,eb,this.__ow);
this.__mW=ea;
this.__mX=eb;
this._updateFocusIndicator();
}},getFocusedColumn:function(){return this.__mW;
...
if(ee!=-1){var ek=this.__ot.getInnerSize();
...
}},isEditing:function(){return this.__oL!=null;
},startEditing:function(){var eu=this.getTable();
var es=eu.getTableModel();
var ew=this.__mW;

if(!this.isEditing()&&(ew!=null)&&es.isColumnEditable(ew)){var ex=this.__mX;
var eq=this.getTablePaneModel().getX(ew);
var er=es.getValue(ew,ex);
this.scrollCellVisible(eq,ex);
this.__oM=eu.getTableColumnModel().getCellEditorFactory(ew);
var et={col:ew,row:ex,xPos:eq,value:er,table:eu};
this.__oL=this.__oM.createCellEditor(et);
if(this.__oL===null){return false;
}else if(this.__oL instanceof qx.ui.window.Window){this.__oL.setModal(true);
this.__oL.setShowClose(false);
this.__oL.addListener(a,this._onCellEditorModalWindowClose,this);
var f=eu.getModalCellEditorPreOpenFunction();

if(f!=null){f(this.__oL,et);
}this.__oL.open();
}else{var ev=this.__ou.getInnerSize();
this.__oL.setUserBounds(0,0,ev.width,ev.height);
this.__ou.addListener(k,function(e){this.__oG={row:this.__mX,col:this.__mW};
e.stopPropagation();
},this);
this.__ou.add(this.__oL);
this.__ou.addState(bk);
this.__ou.setKeepActive(false);
this.__ou.setDecorator(bo);
this.__oL.focus();
this.__oL.activate();
}return true;
}return false;
...
this.cancelEditing();
},flushEditor:function(){if(this.isEditing()){var ez=this.__oM.getCellEditorValue(this.__oL);
var ey=this.getTable().getTableModel().getValue(this.__mW,this.__mX);
this.getTable().getTableModel().setValue(this.__mW,this.__mX,ez);
this.__mI.focus();
this.__mI.fireDataEvent(H,{row:this.__mX,col:this.__mW,oldValue:ey,value:ez});
}},cancelEditing:function(){if(this.isEditing()&&!this.__oL.pendingDispose){if(this._cellEditorIsModalWindow){this.__oL.destroy();
this.__oL=null;
this.__oM=null;
this.__oL.pendingDispose=true;
}else{this.__ou.removeState(bk);
...
var eG=this.__oq.getContentLocation().left;
...
var eO=this.__op.getContainerLocation().left;
...
},_getRowForPagePos:function(eP,eQ){var eR=this.__oq.getContentLocation();

if(eP<eR.left||eP>eR.right){return null;
}
if(eQ>=eR.top&&eQ<=eR.bottom){var eS=this.getTable().getRowHeight();
var scrollY=this.__oo.getPosition();
...
}var eU=this.__op.getContainerLocation();

if(eQ>=eU.top&&eQ<=eU.bottom&&eP<=eU.right){return -1;
}return null;
},setTopRightWidget:function(eY){var fa=this.__oN;

if(fa!=null){this.__or.remove(fa);
}
if(eY!=null){this.__or.add(eY);
}this.__oN=eY;
},getTopRightWidget:function(){return this.__oN;
},getHeader:function(){return this.__op;
},getTablePane:function(){return this.__oq;
},getVerticalScrollBarWidth:function(){var fb=this.__oo;
return fb.isVisible()?(fb.getSizeHint().width||0):0;
},getNeededScrollBars:function(fc,fd){var fm=this.__oo;
...
},getPaneClipper:function(){return this.__ot;
},_applyScrollTimeout:function(ft,fu){this._startInterval(ft);
},_startInterval:function(fv){this.__je.setInterval(fv);
this.__je.start();
},_stopInterval:function(){this.__je.stop();
},_postponedUpdateContent:function(){this._updateContent();
},_oninterval:qx.event.GlobalError.observeMethod(function(){if(this.__ow&&!this.__oq._layoutPending){this.__ow=false;
this._updateContent();
}}),_updateContent:function(){var fA=this.__ot.getInnerSize();

if(!fA){return;
}var fD=fA.height;
var scrollX=this.__on.getPosition();
var scrollY=this.__oo.getPosition();
var fx=this.getTable().getRowHeight();
var fy=Math.floor(scrollY/fx);
var fC=this.__oq.getFirstVisibleRow();
this.__oq.setFirstVisibleRow(fy);
...
if(!fB){fz++;
fw=scrollY%fx;
}this.__oq.setVisibleRowCount(fz);

if(fy!=fC){this._updateFocusIndicator();
}this.__ot.scrollToX(scrollX);
if(!fB){this.__ot.scrollToY(fw);
}},_updateFocusIndicator:function(){var fE=this.getTable();

if(!fE.getEnabled()){return;
}this.__ou.moveToCell(this.__mW,this.__mX);
}},destruct:function(){this._stopInterval();
var fF=this.getTablePaneModel();

if(fF){fF.dispose();
}this.__oG=this.__oN=this.__mI=null;
this._disposeObjects(t,F,L,K,w,v,A,D,S);
}});
})();
...
},properties:{visibility:{refine:true,init:b},row:{check:g,nullable:true},column:{check:g,nullable:true}},members:{__oQ:null,_onKeyPress:function(e){var i=e.getKeyIdentifier();

if(i!==f&&i!==c){e.stopPropagation();
}},moveToCell:function(j,k){if(!this.__oQ.getShowCellFocusIndicator()&&!this.__oQ.getTable().getTableModel().isColumnEditable(j)){this.exclude();
return;
}else{this.show();
}
if(j==null){this.hide();
this.setRow(null);
this.setColumn(null);
}else{var l=this.__oQ.getTablePaneModel().getX(j);

if(l==-1){this.hide();
this.setRow(null);
this.setColumn(null);
}else{var q=this.__oQ.getTable();
var o=q.getTableColumnModel();
var p=this.__oQ.getTablePaneModel();
var n=this.__oQ.getTablePane().getFirstVisibleRow();
...
(function(){var b="qx.ui.window.Manager",a="__oR";
qx.Class.define(b,{extend:qx.core.Object,implement:qx.ui.window.IWindowManager,members:{__oR:null,setDesktop:function(c){this.__oR=c;
this.updateStack();
},getDesktop:function(){return this.__oR;
},changeActiveWindow:function(d,e){if(d){this.bringToFront(d);
d.setActive(true);
}
if(e){e.resetActive();
}},_minZIndex:1e5,updateStack:function(){qx.ui.core.queue.Widget.add(this);
},syncWidget:function(){this.__oR.forceUnblockContent();
var f=this.__oR.getWindows();
...
}}this.__oR.setActiveWindow(k);
},bringToFront:function(n){var o=this.__oR.getWindows();
var p=qx.lang.Array.remove(o,n);

if(p){o.push(n);
this.updateStack();
}},sendToBack:function(q){var r=this.__oR.getWindows();
...
(function(){var l="move",k="Boolean",j="mouseup",i="mousedown",h="losecapture",g="qx.ui.core.MMovable",f="__oT",d="mousemove",c="maximized",b="__oS",a="move-frame";
qx.Mixin.define(g,{properties:{movable:{check:k,init:true},useMoveFrame:{check:k,init:false}},members:{__oS:null,__oT:null,__oU:null,__oV:null,__oW:null,__oX:null,__oY:null,__pa:false,__pb:null,__pc:0,_activateMoveHandle:function(m){if(this.__oS){throw new Error("The move handle could not be redefined!");
}this.__oS=m;
...
},__pd:function(){var n=this.__oT;

if(!n){n=this.__oT=new qx.ui.core.Widget();
n.setAppearance(a);
n.exclude();
...
},__pf:function(e){var r=this.__oU;
var u=Math.max(r.left,Math.min(r.right,e.getDocumentLeft()));
var t=Math.max(r.top,Math.min(r.bottom,e.getDocumentTop()));
var q=this.__oV+u;
var s=this.__oW+t;
return {viewportLeft:q,viewportTop:s,parentLeft:q-this.__oX,parentTop:s-this.__oY};
...
this.__pa=true;
}}this.__oU={left:w.left,top:w.top,right:w.left+x.width,bottom:w.top+x.height};
var v=this.getContainerLocation();
this.__oX=w.left;
this.__oY=w.top;
this.__oV=v.left-e.getDocumentLeft();
this.__oW=v.top-e.getDocumentTop();
this.addState(l);
this.__oS.capture();
...
qx.Mixin.define(k,{properties:{contentPaddingTop:{check:p,init:0,apply:o,themeable:true},contentPaddingRight:{check:p,init:0,apply:o,themeable:true},contentPaddingBottom:{check:p,init:0,apply:o,themeable:true},contentPaddingLeft:{check:p,init:0,apply:o,themeable:true},contentPadding:{group:[e,a,d,c],mode:b,themeable:true}},members:{__ph:{contentPaddingTop:i,contentPaddingRight:h,contentPaddingBottom:m,contentPaddingLeft:f},__pi:{contentPaddingTop:l,contentPaddingRight:n,contentPaddingBottom:g,contentPaddingLeft:j},_applyContentPadding:function(q,r,name){var s=this._getContentPaddingTarget();

if(q==null){var t=this.__pi[name];
s[t]();
}else{var u=this.__ph[name];
s[u](q);
}}}});
})();
...
A.addListener(i,this.__pw,this,true);
A.addListener(q,this.__px,this);
A.addListener(x,this.__pz,this);
A.addListener(s,this.__pA,this);
A.addListener(o,this.__py,this);
var B=this.getContainerElement().getDomElement();

if(B==null){B=window;
}this.__pj=qx.event.Registration.getManager(B).getHandler(qx.event.handler.DragDrop);
},properties:{resizableTop:{check:k,init:true},resizableRight:{check:k,init:true},resizableBottom:{check:k,init:true},resizableLeft:{check:k,init:true},resizable:{group:[l,d,m,y],mode:v},resizeSensitivity:{check:a,init:5},useResizeFrame:{check:k,init:true}},members:{__pj:null,__pk:null,__pl:null,__pm:null,__pn:null,__po:null,__pp:null,RESIZE_TOP:1,RESIZE_BOTTOM:2,RESIZE_LEFT:4,RESIZE_RIGHT:8,_getResizeFrame:function(){var C=this.__pk;

if(!C){C=this.__pk=new qx.ui.core.Widget();
C.setAppearance(p);
C.exclude();
qx.core.Init.getApplication().getRoot().add(C);
}return C;
},__pq:function(){var location=this.__pt();
...
},__pr:function(e){var F=this.__pl;
...
if((F&this.RESIZE_TOP)||(F&this.RESIZE_BOTTOM)){L=Math.max(K.top,Math.min(K.bottom,e.getDocumentTop()))-this.__pn;
...
if((F&this.RESIZE_LEFT)||(F&this.RESIZE_RIGHT)){L=Math.max(K.left,Math.min(K.right,e.getDocumentLeft()))-this.__pm;
...
},__ps:{1:f,2:n,4:h,8:z,5:t,6:g,9:c,10:b},__pt:function(){var O=this.getDecoratorElement();
if(O&&O.getDomElement()){return qx.bom.element.Location.get(O.getDomElement());
}else{return this.getContentLocation();
}},__pu:function(e){var location=this.__pt();
var P=this.getResizeSensitivity();
var S=e.getDocumentLeft();
var R=e.getDocumentTop();
var Q=this.__pv(location,S,R,P);
if(Q>0){Q=Q|this.__pv(location,S,R,P*2);
}this.__pl=Q;
},__pv:function(location,T,U,V){var W=0;
...
},__pw:function(e){if(!this.__pl){return;
}this.addState(j);
this.__pm=e.getDocumentLeft();
this.__pn=e.getDocumentTop();
var bb=this.getContainerLocation();
var X=this.__pt();
var ba=this.getBounds();
this.__po={top:X.top,left:X.left,containerWidth:bb.right-bb.left,containerHeight:bb.bottom-bb.top,width:X.right-X.left,height:X.bottom-X.top,bounds:qx.lang.Object.clone(ba)};
var parent=this.getLayoutParent();
var bc=parent.getContentLocation();
var Y=parent.getBounds();
this.__pp={left:bc.left,top:bc.top,right:bc.left+Y.width,bottom:bc.top+Y.height};
if(this.getUseResizeFrame()){this.__pq();
}this.capture();
e.stop();
},__px:function(e){if(!this.hasState(j)){return;
...
this.releaseCapture();
e.stopPropagation();
},__py:function(e){if(!this.__pl){return;
}this.resetCursor();
this.getApplicationRoot().resetGlobalCursor();
this.removeState(w);
if(this.getUseResizeFrame()){this._getResizeFrame().exclude();
}},__pz:function(e){if(this.hasState(j)){var bh=this.__pr(e);
...
}else if(!this.hasState(u)&&!this.__pj.isSessionActive()){this.__pu(e);
var bi=this.__pl;
var bg=this.getApplicationRoot();

if(bi){var be=this.__ps[bi];
this.setCursor(be);
bg.setGlobalCursor(be);
}else if(this.getCursor()){this.resetCursor();
bg.resetGlobalCursor();
}}},__pA:function(e){if(this.getCursor()&&!this.hasState(j)){this.resetCursor();
this.getApplicationRoot().resetGlobalCursor();
}}},destruct:function(){if(this.__pk!=null&&!qx.core.ObjectRegistry.inShutDown){this.__pk.destroy();
this.__pk=null;
}this.__pj=null;
}});
})();
...
this.__pC=bh.left===undefined?0:bh.left;
this.__pB=bh.top===undefined?0:bh.top;
...
this.__pC=bi.left===undefined?0:bi.left;
this.__pB=bi.top===undefined?0:bi.top;
this.removeState(b);
this.hide();
this.fireEvent(u);
...
},events:{"modelChanged":e},statics:{EVENT_TYPE_MODEL_CHANGED:"modelChanged"},properties:{firstColumnX:{check:c,init:0,apply:d},maxColumnCount:{check:f,init:-1,apply:a}},members:{__pD:null,__pE:null,_applyFirstColumnX:function(j,k){this.__pD=null;
this.fireEvent(qx.ui.table.pane.Model.EVENT_TYPE_MODEL_CHANGED);
},_applyMaxColumnCount:function(l,m){this.__pD=null;
this.fireEvent(qx.ui.table.pane.Model.EVENT_TYPE_MODEL_CHANGED);
},setTableColumnModel:function(n){if(this.__pE){this.__pE.removeListener(g,this._onColVisibilityChanged,this);
this.__pE.removeListener(h,this._onColVisibilityChanged,this);
}this.__pE=n;
this.__pE.addListener(g,this._onColVisibilityChanged,this);
this.__pE.addListener(h,this._onHeaderCellRendererChanged,this);
this.__pD=null;
},_onColVisibilityChanged:function(o){this.__pD=null;
this.fireEvent(qx.ui.table.pane.Model.EVENT_TYPE_MODEL_CHANGED);
},_onHeaderCellRendererChanged:function(p){this.fireEvent(qx.ui.table.pane.Model.EVENT_TYPE_MODEL_CHANGED);
},getColumnCount:function(){if(this.__pD==null){var q=this.getFirstColumnX();
var s=this.getMaxColumnCount();
var r=this.__pE.getVisibleColumnCount();

if(s==-1||(q+s)>r){this.__pD=r-q;
}else{this.__pD=s;
}}return this.__pD;
},getColumnAtX:function(t){var u=this.getFirstColumnX();
return this.__pE.getVisibleColumnAtX(u+t);
},getX:function(v){var w=this.getFirstColumnX();
var y=this.getMaxColumnCount();
var x=this.__pE.getVisibleX(v)-w;
...
if(A==z){return C;
}C+=this.__pE.getColumnWidth(A);
}return -1;
},getTotalWidth:function(){var D=0;
var E=this.getColumnCount();

for(var x=0;x<E;x++){var F=this.getColumnAtX(x);
D+=this.__pE.getColumnWidth(F);
}return D;
}},destruct:function(){if(this.__pE){this.__pE.removeListener(g,this._onColVisibilityChanged,this);
this.__pE.removeListener(h,this._onColVisibilityChanged,this);
}this.__pE=null;
}});
})();
...
}},members:{__pF:null,__ly:null,__lx:null,__pG:null,__ln:null,__lo:null,getRowData:function(B){var C=this.__pF[B];

if(C==null||C.originalData==null){return C;
}else{return C.originalData;
}},getRowDataAsMap:function(D){var F=this.__pF[D];
...
},setEditable:function(K){this.__ly=[];

for(var L=0;L<this.getColumnCount();L++){this.__ly[L]=K;
}this.fireEvent(d);
},setColumnEditable:function(M,N){if(N!=this.isColumnEditable(M)){if(this.__ly==null){this.__ly=[];
}this.__ly[M]=N;
this.fireEvent(d);
}},isColumnEditable:function(O){return this.__ly?(this.__ly[O]==true):false;
},setColumnSortable:function(P,Q){if(Q!=this.isColumnSortable(P)){if(this.__lx==null){this.__lx=[];
}this.__lx[P]=Q;
this.fireEvent(d);
}},isColumnSortable:function(R){return (this.__lx?(this.__lx[R]!==false):true);
...
},getSortMethods:function(bd){return this.__pG[bd];
},clearSorting:function(){if(this.__ln!=-1){this.__ln=-1;
this.__lo=true;
this.fireEvent(d);
}},getSortColumnIndex:function(){return this.__ln;
},_setSortColumnIndex:function(be){this.__ln=be;
},isSortAscending:function(){return this.__lo;
},_setSortAscending:function(bf){this.__lo=bf;
},getRowCount:function(){return this.__pF.length;
},getValue:function(bg,bh){if(bh<0||bh>=this.__pF.length){throw new Error("this.__rowArr out of bounds: "+bh+" (0.."+this.__pF.length+")");
}return this.__pF[bh][bg];
},setValue:function(bi,bj,bk){if(this.__pF[bj][bi]!=bk){this.__pF[bj][bi]=bk;
if(this.hasListener(e)){var bl={firstRow:bj,lastRow:bj,firstColumn:bi,lastColumn:bi};
this.fireDataEvent(e,bl);
}
if(bi==this.__ln){this.clearSorting();
}}},setData:function(bm,bn){this.__pF=bm;
...
}},getData:function(){return this.__pF;
},setDataAsMapArray:function(bp,bq,br){this.setData(this._mapArray2RowArr(bp,bq),br);
},addRows:function(bs,bt,bu){if(bt==null){bt=this.__pF.length;
}bs.splice(0,0,bt,0);
Array.prototype.splice.apply(this.__pF,bs);
var bv={firstRow:bt,lastRow:this.__pF.length-1,firstColumn:0,lastColumn:this.getColumnCount()-1};
...
Array.prototype.splice.apply(this.__pF,bA);
var bD={firstRow:bB,lastRow:this.__pF.length-1,firstColumn:0,lastColumn:this.getColumnCount()-1};
...
},removeRows:function(bI,bJ,bK){this.__pF.splice(bI,bJ);
var bL={firstRow:bI,lastRow:this.__pF.length-1,firstColumn:0,lastColumn:this.getColumnCount()-1,removeStart:bI,removeCount:bJ};
this.fireDataEvent(e,bL);
...
}},destruct:function(){this.__pF=this.__ly=this.__pG=this.__lx=null;
}});
})();
...
(function(){var a="rpc_test.theme.Color";
...
(function(){var a="rpc_test.theme.Appearance";
...
(function(){var a="rpc_test.theme.Font";
...
}},members:{__lb:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__lb;
},getMarkup:function(e){if(this.__lb){return this.__lb;
...
qx.Mixin.define(o,{include:[qx.ui.decoration.MSingleBorder,qx.ui.decoration.MBackgroundImage],construct:function(){this._getDefaultInsetsForBorder=this.__lg;
this._resizeBorder=this.__lf;
this._styleBorder=this.__ld;
this._generateMarkup=this.__le;
},properties:{innerWidthTop:{check:f,init:0},innerWidthRight:{check:f,init:0},innerWidthBottom:{check:f,init:0},innerWidthLeft:{check:f,init:0},innerWidth:{group:[w,z,n,k],mode:a},innerColorTop:{nullable:true,check:g},innerColorRight:{nullable:true,check:g},innerColorBottom:{nullable:true,check:g},innerColorLeft:{nullable:true,check:g},innerColor:{group:[u,v,x,r],mode:a}},members:{__lc:null,__ld:function(D){var E=qx.theme.manager.Color.getInstance();
D.position=t;
...
}},__le:function(G){var J=this._generateBackgroundMarkup(G);
...
G[y]=0;
G[p]=0;
return this.__lc=this._generateBackgroundMarkup(G,J);
},__lf:function(K,L,M){var N=this.getInsets();
L-=N.left+N.right;
M-=N.top+N.bottom;
...
},__lg:function(){return {top:this.getWidthTop()+this.getInnerWidthTop(),right:this.getWidthRight()+this.getInnerWidthRight(),bottom:this.getWidthBottom()+this.getInnerWidthBottom(),left:this.getWidthLeft()+this.getInnerWidthLeft()};
}}});
})();
...
}},properties:{innerColor:{check:d,nullable:true,apply:i},innerOpacity:{check:o,init:1,apply:i},outerColor:{check:d,nullable:true,apply:i}},members:{__lb:null,_getDefaultInsets:function(){return {top:2,right:2,bottom:2,left:2};
},_isInitialized:function(){return !!this.__lb;
},_applyStyle:function(){},getMarkup:function(){if(this.__lb){return this.__lb;
...
if(qx.ui.decoration.css3.BorderImage.IS_SUPPORTED){this.__lh=new qx.ui.decoration.css3.BorderImage();

if(p){this.__li(p);
}}else{this.__lh=new qx.ui.decoration.GridDiv(p);
}
if(q!=null){this.__lh.setInsets(q);
}},properties:{baseImage:{check:d,nullable:true,apply:j},insetLeft:{check:o,nullable:true,apply:n},insetRight:{check:o,nullable:true,apply:n},insetBottom:{check:o,nullable:true,apply:n},insetTop:{check:o,nullable:true,apply:n},insets:{group:[k,l,i,e],mode:f}},members:{__lh:null,getMarkup:function(){return this.__lh.getMarkup();
},resize:function(r,s,t){this.__lh.resize(r,s,t);
},tint:function(u,v){},getInsets:function(){return this.__lh.getInsets();
},_applyInsets:function(w,x,name){var y=g+qx.lang.String.firstUp(name);
this.__lh[y](w);
},_applyBaseImage:function(z,A){if(this.__lh instanceof qx.ui.decoration.GridDiv){this.__lh.setBaseImage(z);
}else{this.__li(z);
}},__li:function(B){var G,H,J,I;
this.__lh.setBorderImage(B);
...
}},statics:{IS_SUPPORTED:qx.bom.element.Style.isPropertySupported("borderImage")},properties:{borderImage:{check:t,nullable:true,apply:j},sliceTop:{check:h,init:0,apply:j},sliceRight:{check:h,init:0,apply:j},sliceBottom:{check:h,init:0,apply:j},sliceLeft:{check:h,init:0,apply:j},slice:{group:[n,v,a,w],mode:c},repeatX:{check:[i,e,d],init:i,apply:j},repeatY:{check:[i,e,d],init:i,apply:j},repeat:{group:[u,m],mode:c}},members:{__lb:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__lb;
},getMarkup:function(){if(this.__lb){return this.__lb;
...
this.__lb=[x,qx.bom.element.Style.compile({"borderImage":o+B+p+C.join(f)+f+D,position:k,lineHeight:0,fontSize:0,overflow:l,boxSizing:r,borderWidth:C.join(b)+g}),y].join(q);
return this.__lb;
...
(function(){var a="rpc_test.theme.Decoration";
qx.Theme.define(a,{extend:qx.theme.modern.Decoration,decorations:{}});
})();
(function(){var a="rpc_test.theme.Theme";
qx.Theme.define(a,{meta:{color:rpc_test.theme.Color,decoration:rpc_test.theme.Decoration,font:rpc_test.theme.Font,icon:qx.theme.icon.Tango,appearance:rpc_test.theme.Appearance}});
})();
