...
from clacks.common.components import JSONServiceProxy, JSONRPCException, AMQPServiceProxy
    ...
    def get_para_help(self, para):
        ...
        help_msgs = {
                ...
                "acl-definition": _("The <acl-defintion> parameter specifies what actions can be performed on a given topic."
                    ...
                    "\n       '^org\.clacks\..*:crowdsexm'"
                    "\n"
                    "\n   A single definition with options:"
                    "\n       '^org\.clacks\..*:crowdsexm:uid=user_*:tag=event'"
                    "\n"
                    "\n   A multi action defintion"
                    "\n       '^org\.clacks\.events$:crowdsexm,^org\.clacks\.factory$:rw,^org\.clacks\.something$:rw'"
                    "\n"
                    "\n <topic> "
                    "\n ========"
